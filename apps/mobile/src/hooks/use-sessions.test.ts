...
describe('useFailedFreeformLibraryFilingSessions', () => {
  const failedFreeformSessionId = '11111111-1111-7111-8111-111111111111';
  const failedLearningSessionId = '33333333-3333-7333-8333-333333333333';
  const pendingFreeformSessionId = '44444444-4444-7444-8444-444444444444';
  const subjectId = '22222222-2222-7222-8222-222222222222';

  function makeSessionDetail(input: {
    id: string;
    filingStatus: 'filing_failed' | 'filing_pending';
    ...
    return {
      session: {
        ...
        lastActivityAt: '2026-05-25T10:05:00.000Z',
        endedAt: '2026-05-25T10:05:00.000Z',
        durationSeconds: 300,
        wallClockSeconds: 300,
        metadata: { effectiveMode: input.effectiveMode },
        filedAt: null,
        filingStatus: input.filingStatus,
        filingRetryCount: input.filingStatus === 'filing_failed' ? 3 : 1,
      },
    };
  }

  it('lists only failed freeform Library filing sessions from existing session endpoints', async () => {
    mockFetch.mockImplementation((url: string) => {
      if (url.includes('/progress/sessions')) {
        return Promise.resolve(
          new Response(
            JSON.stringify({
              sessions: [
                {
                  sessionId: failedFreeformSessionId,
                  subjectId,
                  subjectName: 'Math',
                  topicId: null,
                  topicTitle: null,
                ...
                {
                  sessionId: failedLearningSessionId,
                  subjectId,
                  subjectName: 'Math',
                  topicId: null,
                  topicTitle: null,
                  sessionType: 'learning',
                  startedAt: '2026-05-25T10:10:00.000Z',
                  endedAt: '2026-05-25T10:15:00.000Z',
                  exchangeCount: 3,
                  escalationRung: 1,
                  durationSeconds: 300,
                  wallClockSeconds: 300,
                ...
                {
                  sessionId: pendingFreeformSessionId,
                  subjectId,
                  subjectName: 'Math',
                  topicId: null,
                  topicTitle: null,
                  sessionType: 'learning',
                  startedAt: '2026-05-25T10:20:00.000Z',
      ...
      if (url.includes(failedFreeformSessionId)) {
        return Promise.resolve(
          new Response(
            JSON.stringify(
              makeSessionDetail({
                id: failedFreeformSessionId,
      ...
      if (url.includes(failedLearningSessionId)) {
        return Promise.resolve(
          new Response(
            JSON.stringify(
              makeSessionDetail({
                id: failedLearningSessionId,
                filingStatus: 'filing_failed',
