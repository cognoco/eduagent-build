...
jest.mock(
  '../../components/welcome/WelcomeIntro',
  /* The WelcomeIntro component is covered by its own unit suite. The route
     test stubs it to a minimal driver so we can verify ONLY the route's
     wiring (analytics, intro-state, redirect param, router.replace). */
  () => ({
    WelcomeIntro: ({
      onComplete,
      onCardAdvanced,
