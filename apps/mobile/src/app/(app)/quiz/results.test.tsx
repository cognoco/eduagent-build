...
// ---------------------------------------------------------------------------
// [BUG-893] null-context safety guard — separate top-level describe so future
// readers scanning for BUG-893 coverage find it under a guard-specific block,
// not buried inside the F-040 missed-question describe.
// ---------------------------------------------------------------------------
...
describe('QuizResultsScreen — [BUG-893] null-context safety guard', () => {
  it('calls router.replace, never router.back, even when canGoBack=true', () => {
