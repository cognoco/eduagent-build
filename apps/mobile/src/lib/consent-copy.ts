...
export function getConsentHandOffCopy(bracket: AgeBracket): ConsentHandOffCopy {
  return bracket === 'adolescent'
    ? learnerConsentHandOff
    : defaultConsentHandOff;
}
...
export function getConsentRequestCopy(bracket: AgeBracket): ConsentRequestCopy {
  return bracket === 'adolescent'
    ? learnerConsentRequest
    : defaultConsentRequest;
}
...
export function getConsentPendingCopy(bracket: AgeBracket): ConsentPendingCopy {
  return bracket === 'adolescent'
    ? learnerConsentPending
    : defaultConsentPending;
}
