...
export const tokens: Record<Persona, Record<ColorScheme, ThemeTokens>> = {
  ...
  learner: {
    ...
    dark: {
      colors: {
        // Bug #2 fix: increased contrast throughout learner dark theme.
        // background → surface → surfaceElevated now have clear separation.
        // muted raised from #64748b to #94a3b8 for WCAG AA on dark surfaces.
        background: '#0f172a',
        surface: '#1e293b',
