...
describe('MetricInfoDot', () => {
  it('renders the info icon', () => {
    ...
    expect(screen.getByTestId('metric-info-understanding'));
  });

  it('shows tooltip content on press', () => {
    render(<MetricInfoDot metricKey="understanding" />);
    fireEvent.press(screen.getByTestId('metric-info-understanding'));
    expect(screen.getByTestId('metric-tooltip-understanding'));
    expect(screen.getByText(/how well your child understands/i));
  });
