...
jest.mock('../../services/consent' /* gc1-allow: pattern-a conversion */, () => ({
  ...jest.requireActual('../../services/consent'), // gc1-allow: isolates archive cleanup guards from consent service DB access
...
jest.mock('../../services/deletion' /* gc1-allow: pattern-a conversion */, () => ({
  ...jest.requireActual('../../services/deletion'), // gc1-allow: prevents destructive profile deletion while asserting the handler boundary
