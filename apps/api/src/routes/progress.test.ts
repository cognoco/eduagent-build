...
// [WI-2416] assertCanReadProfile (all GET /progress* / /subjects/*/progress
// routes) calls verifyPersonOwnershipV2, which — like getPersonScope above —
// runs a raw db.select() membership query unrunnable on this unit mock DB.
// Every scenario in this file is a caller-self read (the header profile
// equals the authenticated caller's own person id); the cross-account read
