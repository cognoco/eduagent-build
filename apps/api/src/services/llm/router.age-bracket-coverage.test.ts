...
const WI_2520_DEFERRED_SITES: Readonly<Record<string, string>> = {
  ...
  'apps/api/src/services/curriculum.ts:134': 'deferred, tracked as WI-2520',
  'apps/api/src/services/curriculum.ts:209': 'deferred, tracked as WI-2520',
  'apps/api/src/services/curriculum.ts:2942': 'deferred, tracked as WI-2520',
