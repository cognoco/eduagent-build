...
const WI_2520_DEFERRED_SITES: Readonly<Record<string, string>> = {
  ...
  'apps/api/src/services/curriculum.ts:135': 'deferred, tracked as WI-2520',
  'apps/api/src/services/curriculum.ts:210': 'deferred, tracked as WI-2520',
  'apps/api/src/services/curriculum.ts:2965': 'deferred, tracked as WI-2520',
