...
describe('validateEvaluationEventIds — [#477] ownership guard', () => {
  ...
  const evals: ChallengeRoundEvaluationItem[] = [
    {
      ...
      result: 'solid',
      evidence: 'x',
      answerEventId: 'aaaaaaaa-0000-0000-0000-000000000001',
    ...
    },
    {
      ...
      result: 'partial',
      evidence: 'y',
      answerEventId: 'aaaaaaaa-0000-0000-0000-000000000002',
  ...
  it('[#477] rejects the whole evaluation when any answerEventId is missing from the session', async () => {
    ...
    const db = makeSessionEventsDb([
      { id: 'aaaaaaaa-0000-0000-0000-000000000001', content: 'real content a' },
    ]);
    await expect(
