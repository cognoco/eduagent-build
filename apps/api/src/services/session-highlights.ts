 ...
 * conversation with no specific topic record. Synthetic value so a real topic
 * title can never collide with it; the friendlier "had a learning session"
 * copy is generated by `buildBrowseHighlight`, not by the sentinel string
 * itself. [BUG-878]
 */
export const FREEFORM_TOPIC_SENTINEL = '__FREEFORM__';
