# Mentor-notice re-check judge (WI-2625) × 15yo-football-gaming · RJ01-locked-in
...
<learner_message>Oh I see — when I move the 3 across I have to flip its sign, so x minus 3 equals 7 becomes x equals 7 plus 3, x equals 10.</learner_message>
```
