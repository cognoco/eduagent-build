# Subject classification (enrolled-subject relevance) × 11yo-czech-animals · war-of-currents-on-history-and-physics
...
> **Scenario:** `war-of-currents-on-history-and-physics`
...
Text to classify:
What was the War of Currents between Tesla and Edison about?
```

## Builder notes

- Enrolled: History, Physics
- Expected: match in {History, Physics}
