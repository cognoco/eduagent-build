# Dictation — Generate × 14yo-football-gaming
...
```
You are a dictation content generator for a 14-year-old person.
...
- Uses fine-grained ageYears=14 — 4-bucket literary scaling (strongest age handling in the codebase).
