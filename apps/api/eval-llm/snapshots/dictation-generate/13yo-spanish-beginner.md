...
```json
{
  "sentences": [
    {
      "text": "Elara watched her magnificent steed.",
      "withPunctuation": "Elara watched her magnificent steed period",
      "wordCount": 6,
      "chunks": ["Elara watched her magnificent steed."],
      "chunksWithPunctuation": ["Elara watched her magnificent steed period"]
    },
    {
      "text": "Its coat gleamed like polished copper.",
      "withPunctuation": "Its coat gleamed like polished copper period",
      "wordCount": 6,
      "chunks": ["Its coat gleamed like polished copper."],
      "chunksWithPunctuation": ["Its coat gleamed like polished copper period"]
    },
    {
      "text": "Don Rafael, the stable master, approached.",
      "withPunctuation": "Don Rafael comma the stable master comma approached period",
      "wordCount": 6,
      "chunks": ["Don Rafael,", "the stable master,", "approached."],
      "chunksWithPunctuation": ["Don Rafael comma", "the stable master comma", "approached period"]
    },
    {
      "text": "He whispered forgotten equestrian legends.",
      "withPunctuation": "He whispered forgotten equestrian legends period",
      "wordCount": 5,
      "chunks": ["He whispered forgotten equestrian legends."],
      "chunksWithPunctuation": ["He whispered forgotten equestrian legends period"]
    },
    {
      "text": "They trained daily for the grand event.",
      "withPunctuation": "They trained daily for the grand event period",
      "wordCount": 7,
      "chunks": ["They trained daily", "for the grand event."],
      "chunksWithPunctuation": ["They trained daily", "for the grand event period"]
    },
    {
      "text": "A challenging cross-country course awaited.",
      "withPunctuation": "A challenging cross-country course awaited period",
      "wordCount": 5,
      "chunks": ["A challenging cross-country course awaited."],
      "chunksWithPunctuation": ["A challenging cross-country course awaited period"]
    },
    {
      "text": "The sun cast long shadows over the paddocks.",
      "withPunctuation": "The sun cast long shadows over the paddocks period",
      "wordCount": 8,
      "chunks": ["The sun cast long shadows", "over the paddocks."],
      "chunksWithPunctuation": ["The sun cast long shadows", "over the paddocks period"]
    },
    {
      "text": "Every hoofbeat promised a thrilling adventure.",
      "withPunctuation": "Every hoofbeat promised a thrilling adventure period",
      "wordCount": 6,
      "chunks": ["Every hoofbeat promised", "a thrilling adventure."],
      "chunksWithPunctuation": ["Every hoofbeat promised", "a thrilling adventure period"]
    }
  ],
  "title": "The Equestrian's Quest",
  "topic": "An adventure story featuring horses, training, and a touch of mystery.",
  "language": "en"
}
```
```
