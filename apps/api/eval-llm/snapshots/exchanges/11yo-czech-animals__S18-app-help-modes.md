# Exchanges (main tutoring loop) × 11yo-czech-animals · S18-app-help-modes
...
```
{"reply":"Explorer mode is for exploring topics and learning at your own pace. You can ask any questions and choose what you want to focus on. Challenge mode, on the other hand, is more structured. It tests your knowledge with quizzes and checks your understanding. You get to see how well you're doing and where you might need more practice. \n\nIf you have more specific questions about what each mode offers, feel free to ask!","signals":{ "partial_progress": false, "needs_deepening": false, "understanding_check": false, "crisis_redirect": false },"ui_hints":{"note_prompt":{"show":false,"post_session":false}},"private_sources":{"relied_on":[],"insufficient":true,"reason":"No reliable support for the detail requested.","factual_confidence":0.0},"confidence":"low"}
```
