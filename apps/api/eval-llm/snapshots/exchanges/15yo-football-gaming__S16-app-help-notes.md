...
```
{"reply":"You can find your notes by going to Home > My Notes > Notes. If you want notes specific to a topic or subject, go to Library, choose the subject, then the book or topic, and you'll see your notes there.","signals":{ "partial_progress": false, "needs_deepening": false, "understanding_check": false, "crisis_redirect": false }, "ui_hints":{ "note_prompt":{ "show": false, "post_session": false } }, "private_sources":{ "relied_on": [], "insufficient": false, "reason": "", "factual_confidence": 0.0 }, "confidence": "low"}
```
