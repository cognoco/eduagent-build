# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S19-app-help-memory
...
```json
{
  "scenarioId": "S19-app-help-memory",
  "scenarioPurpose": "App-help: user asks where to see mentor memory",
  "context": {
...
- Scenario: S19-app-help-memory — App-help: user asks where to see mentor memory
