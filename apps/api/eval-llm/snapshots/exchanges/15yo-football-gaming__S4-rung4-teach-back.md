...
```
{
  "reply": "Got it! When you say \"the rule,\" what kind of rule do you mean? Maybe there's an example you can show me how you'd use it?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Learner is starting to explain but hasn't identified specific rules yet.",
