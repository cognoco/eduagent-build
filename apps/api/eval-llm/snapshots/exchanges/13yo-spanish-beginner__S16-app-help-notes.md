# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S16-app-help-notes
...
```json
{
  "scenarioId": "S16-app-help-notes",
  "scenarioPurpose": "App-help: user asks where to find notes mid-session",
  "context": {
...
- Scenario: S16-app-help-notes — App-help: user asks where to find notes mid-session
