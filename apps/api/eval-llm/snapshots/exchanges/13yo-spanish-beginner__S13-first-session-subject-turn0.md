...
```
{
  "reply": "Hi there! Before we jump into Spanish verbs, quick question: what brought you to Languages? Anything specific you want to be able to do?",
  "signals": { "partial_progress": false, "needs_deepening": false, "understanding_check": false },
