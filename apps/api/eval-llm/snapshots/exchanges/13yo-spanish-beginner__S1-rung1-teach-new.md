# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S1-rung1-teach-new
...
```
{
  "reply": "Spanish present tense — one concrete idea: regular -AR verbs change their ending to show who does the action. To conjugate a regular -AR verb, drop -ar from the infinitive and add these endings: -o, -as, -a, -amos, -áis, -an for yo, tú, él/ella/usted, nosotros, vosotros, ellos/ustedes. Example with hablar: yo hablo, tú hablas, él habla, nosotros hablamos, vosotros habláis, ellos hablan. The reason this works is subject-verb agreement: the ending tells who is acting, so you do not need a separate word for the subject every time. Conjugate estudiar for yo, tú, and nosotros?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used current_topic for the rule that regular -AR verbs drop -ar and take present-tense endings; provided example and subject-pronoun mapping from that topic.",
