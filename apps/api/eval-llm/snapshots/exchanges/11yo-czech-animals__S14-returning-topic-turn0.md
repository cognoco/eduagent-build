...
```json
{
  "reply": "When you start reading in a new language like Czech, you might notice some words look a lot like English words. These words are called \"cognates.\" They are words that sound similar and have a similar meaning because they come from the same origin, like two branches growing from the same tree.\n\nFor example, the Czech word \"informace\" means \"information\" in English. They look and sound very similar, right?\n\nCan you think of any other words that might be cognates between English and another language you know, or even just guess one that looks similar?",
  "signals": {
