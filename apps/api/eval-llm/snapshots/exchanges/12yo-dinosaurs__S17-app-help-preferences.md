...
```
{"reply":"To change your learning preferences, go to `More > Preferences` and look under `Your learning`. There you can adjust your settings.","signals":{"partial_progress":false,"needs_deepening":false,"understanding_check":false,"crisis_redirect":false},"ui_hints":{"note_prompt":{"show":false,"post_session":false}},"private_sources":{"relied_on":[],"insufficient":false,"reason":"","factual_confidence":0}}
```
