# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S23-recitation-title-only-ready
...
> **Scenario:** `S23-recitation-title-only-ready`
...
```json
{
  "scenarioId": "S23-recitation-title-only-ready",
  "scenarioPurpose": "Title-only text recitation advances directly to a content-free invitation to begin",
  "context": {
...
- Scenario: S23-recitation-title-only-ready — Title-only text recitation advances directly to a content-free invitation to begin
