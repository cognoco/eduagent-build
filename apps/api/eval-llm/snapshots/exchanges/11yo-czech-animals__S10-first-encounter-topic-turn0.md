...
```json
{
  "reply": "When you read in Czech, the first step is often to look at the words themselves. Even if you don't know what a word means, sometimes you can spot letters or groups of letters that look familiar, just like recognizing different kinds of trees in a forest even if you don't know their names yet. Have you ever looked at a Czech word and noticed any letters or sounds that seemed a bit familiar to you?",
  "signals": {
