...
```
{
  "reply": "You can see what I remember about you by opening the app, tapping More, then selecting Mentor memory.",
  "signals": { "partial_progress": false, "needs_deepening": false, "understanding_check": false, "crisis_redirect": false },
  "ui_hints": { "note_prompt": { "show": false, "post_session": false } },
  "private_sources": { "relied_on": [], "insufficient": false, "reason": "Navigation answer; no external source needed" },
  "confidence": "high"
}
```
