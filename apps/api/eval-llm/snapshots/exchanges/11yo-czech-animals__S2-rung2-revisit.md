...
```
{
  "reply": "Good question — that's a differenttopic. Let's finish this one first, then you can start a session on that.",
  "signals": {
  ...
  "private_sources": {
    "relied_on": [],
    "insufficient": false,
    "reason": "Redirected to stay within loaded topic."
  },
  "confidence": "high"
}
```
