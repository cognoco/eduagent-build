...
```
{
  "reply": "Open the app, tap More,then choose Preferences under the ‘Your learning’ section. From there you can adjust the settings that affect how you learn.",
  "signals": {
  ...
  "private_sources": {
    "relied_on": [],
    "insufficient": false,
    "reason": "Answer based on internal app navigation map"
  },
  "confidence": "high"
}
```
