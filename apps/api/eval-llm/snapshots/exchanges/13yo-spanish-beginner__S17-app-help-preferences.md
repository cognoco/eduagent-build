# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S17-app-help-preferences
...
> **Scenario:** `S17-app-help-preferences`
...
```json
{
  "scenarioId": "S17-app-help-preferences",
  "scenarioPurpose": "App-help: user asks how to change learning preferences",
  "context": {
...
- Scenario: S17-app-help-preferences — App-help: user asks how to change learning preferences
