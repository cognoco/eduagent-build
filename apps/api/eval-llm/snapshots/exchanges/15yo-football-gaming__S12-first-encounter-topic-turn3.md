# Exchanges (main tutoring loop) × 15yo-football-gaming · S12-first-encounter-topic-turn3
...
```
That's a super common mix-up! Let's think about it like a football game.

A player needs food, right? That food gives them the *energy* to run and play.
But for the game itself, they also need equipment, like a helmet and pads. Those are like the *ingredients* for playing. They don't give energy directly, but they're necessary parts of the game.

For a plant, sunlight is like the *energy* source that powers everything. Water and carbon dioxide are the *ingredients* it uses to build sugar. They don't provide energy themselves, but they're what the plant "cooks" with.

Does that help clarify the difference between something that provides energy and something that's an ingredient?
```
