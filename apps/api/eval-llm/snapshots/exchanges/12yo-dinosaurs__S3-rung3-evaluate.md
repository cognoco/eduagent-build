...
```
JSON parse failed: Unexpected token 'T', "That's a g"... is not valid JSON
```
...
The Mesozoic Era is a huge slice of Earth's history, from about 252 to 66 million years ago. It's often called the "Age of Reptiles" because giant reptiles, especially dinosaurs, were the dominant animals on land.

This big era is split into three smaller parts, like a book with three chapters:
1. The Triassic Period
2. The Jurassic Period
3. The Cretaceous Period

So, if you think of the Mesozoic Era as a 3-chapter story, what is that story mostly about?
```
