...
```json
{
  "reply": "Okay, a definition and then an example is a great plan. Let's start there.\n\nIn your own words, what does 'reading comprehension' mean? Imagine you're reading a book about horses for your nature journal. What is your brain doing besides just seeing the words on the page?",
  "signals": {
