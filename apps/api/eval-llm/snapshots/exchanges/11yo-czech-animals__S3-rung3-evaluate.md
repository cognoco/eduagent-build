...
```
{
  "reply": "Quick check — let me try to trip you up.\nOne approach to Czech reading comprehension says you should translate every Czech word directly into English and then read the English sentence. For example, 'Kočka sedí na okně' becomes 'cat sits on window.' This way, you think you'll get the meaning just by literal translation. What is the flaw in this explanation?",
  "signals": {
  ...
  "private_sources": {
    "relied_on": [],
    "insufficient": false,
    "reason": "Presenting a flawed explanation for the learner to identify"
  },
  "confidence": "high"
}
```
