...
```
{
  "reply": "Which rule are you trying to use? What do you think the first step is?",
  "signals": {
  ...
  "private_sources": {
    "relied_on": [],
    "insufficient": false,
    "reason": "No factual claim made; asking clarification to elicit learner's explanation."
  },
  "confidence": "high"
}
```
