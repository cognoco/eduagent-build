# Exchanges (main tutoring loop) × 11yo-czech-animals · S22-challenge-drafting
...
> **Scenario:** `S22-challenge-drafting`
...
```json
{
  "scenarioId": "S22-challenge-drafting",
  "scenarioPurpose": "Challenge Round drafting — state machine in \"drafting\"; prompt should include note-draft instruction block",
  "context": {
...
- Scenario: S22-challenge-drafting — Challenge Round drafting — state machine in "drafting"; prompt should include note-draft instruction block
...
```
{"reply":"Great! Let's start with a brief definition. Czech reading comprehension is a skill to understand and interpret written texts in Czech. It involves recognizing vocabulary, understanding grammar, and figuring out the main ideas and details. \n\nLet's try an example:\nImagine you're reading a story about a horse in a forest. As you read, you'd look for clues about the horse's actions and feelings. If the text says, 'The horse galloped joyfully through the trees', you'd understand that the horse is feeling happy and energetic.\n\nCan you summarize what comprehension involves using this example?","signals": {"partial_progress": false, "needs_deepening": false, "understanding_check": true, "crisis_redirect": false}, "ui_hints": { "note_prompt": { "show": false, "post_session": false } }, "private_sources": { "relied_on": ["current_topic"], "insufficient": false, "reason": "Used provided topic for explanation and example.", "factual_confidence": 1.0 }, "confidence": "high"}
```
