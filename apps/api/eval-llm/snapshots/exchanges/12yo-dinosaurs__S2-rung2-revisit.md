...
```
{
  "reply": "Good question — that's a different topic. Let's finish the Mesozoic era first, then you can start a session on long division.",
  "signals": {
  ...
  "private_sources": {
    "relied_on": [],
    "insufficient": false,
    "reason": "Redirected user to correct topic per policy"
  },
  "confidence": "high"
}
```
