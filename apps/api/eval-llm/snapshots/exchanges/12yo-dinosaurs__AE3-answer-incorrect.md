# Exchanges (main tutoring loop) × 12yo-dinosaurs · AE3-answer-incorrect
...
```json
{
  "scenarioId": "AE3-answer-incorrect",
  "scenarioPurpose": "Answer-evaluation enabled — a substantive wrong answer to the immediately preceding ordinary question must emit correctness=incorrect",
  "context": {
...
- Scenario: AE3-answer-incorrect — Answer-evaluation enabled — a substantive wrong answer to the immediately preceding ordinary question must emit correctness=incorrect
