# Exchanges (main tutoring loop) × 13yo-spanish-beginner · S20-challenge-offered
...
```
{"reply":"Great approach. Let's start with some basics about Spanish present tense verbs.\n\n1. **Definition**: In Spanish, present tense verbs describe actions that are happening right now or general truths. Similar to English, every subject pronoun in Spanish (like 'yo', 'tú', 'él', etc.) matches with a specific verb ending.\n\n2. **Conjugation Example**: Let's take the verb _hablar_, which means \"to speak.\"\n   - Yo hablo (I speak)\n   - Tú hablas (You speak)\n   - Él/Ella habla (He/She speaks)\n\nNotice how the endings change based on the subject pronoun.\n\nNow, here's a quick check: What's the 'nosotros' form of _hablar_ in the present tense?","signals": {"partial_progress": false, "needs_deepening": false, "understanding_check": true, "crisis_redirect": false}, "ui_hints": {"note_prompt": {"show": false, "post_session": false}}, "private_sources": {"relied_on": ["current_topic"], "insufficient": false, "reason": "Supporting check on Spanish present tense verbs through a basic example.", "factual_confidence": 1.0}, "confidence": "high"}
```
