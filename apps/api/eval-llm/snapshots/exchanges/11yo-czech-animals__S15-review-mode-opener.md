# Exchanges (main tutoring loop) × 11yo-czech-animals · S15-review-mode-opener
...
```
{
  "reply": "Let's start with Czech reading comprehension.\nFirst, reading comprehension means understanding the meaning of a text and being able to answer questions about it.\nSecond, Czech uses grammatical cases, so the endings of nouns change depending on their role in the sentence. Noticing these endings helps you figure out who is doing what.\nNow, a quick check: When you see a Czech word ending change, what information does that give you about the word?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used current_topic for factual content about Czech reading comprehension.",
