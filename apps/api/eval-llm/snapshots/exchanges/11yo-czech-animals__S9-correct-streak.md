...
```
{
"reply": "Reading in Czech uses context clues to guess unknown words. Word endings tell you the role of each word. Does the main verb usually appear before the subject in a Czech sentence?",
  "signals": { "partial_progress": false, "needs_deepening": false, "understanding_check": true, "crisis_redirect": false },
  "ui_hints": { "note_prompt": { "show": false, "post_session": false } },
  "private_sources": { "relied_on": ["general_knowledge"], "insufficient": false, "reason": "High confidence general knowledge about Czech reading comprehension used.", "factual_confidence": 0.94 },
  "confidence": "high"
}
```
