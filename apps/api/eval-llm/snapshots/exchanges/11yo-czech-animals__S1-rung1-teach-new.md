...
```
{
  "reply": "In Czech, nouns change form to show their role; this is called a case. Because the endings tell you who is doing what, you can move the word order around. Czech also has signal words like protože (because) that show cause‑and‑effect.\nWhen you read a Czech text, first skim it to get the overall picture, like looking at a quick sketch of a forest. Then read it again, focusing on key words and those signal words to spot the main idea.\nWhat step would you take first to find the main idea of a Czech paragraph about a horse in the forest?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used general knowledge for Czech grammar facts and reading comprehension strategies; used current_topic to frame lesson.",
