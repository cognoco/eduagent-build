...
```
{
  "reply": "When you're reading in Czech, it can feel like there are many new words. A good way to start is by looking for words that you already know, or words that look similar to English words. These are called cognates. For example, the Czech word \"student\" looks and means almost the same as the English word \"student.\"\n\nCan you think of any other words that might be similar in Czech and English, like \"student\"?",
  "signals": {
