# Exchanges (main tutoring loop) × 11yo-czech-animals · S1-rung1-teach-new
...
```
{"reply":"Czech reading comprehension involves understanding and interpreting written texts in the Czech language. It's important to focus on two main skills: recognizing the main idea of a text and identifying supporting details. Recognizing the main idea helps you understand the overall message, while supporting details provide evidence and clarity to that main idea.\n\nFor example, if you read a story about a horse living in a beautiful forest, the main idea might be about how the horse finds happiness in nature. Supporting details could include descriptions of the forest, other animals that live there, and the adventures the horse has.\n\nLet's practice by reading a short paragraph together! Can you tell me what the main idea could be in a text about a forest animal?","signals":{"partial_progress":false,"needs_deepening":false,"understanding_check":true,"crisis_redirect":false},"ui_hints":{"note_prompt":{"show":false,"post_session":false}},"private_sources":{"relied_on":["current_topic"],"insufficient":false,"reason":"Direct teaching based on the current topic about Czech reading comprehension.","factual_confidence":1.0},"confidence":"high"}
```
