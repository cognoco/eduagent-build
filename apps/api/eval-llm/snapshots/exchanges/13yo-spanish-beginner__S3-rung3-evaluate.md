...
```
{
  "reply": "Okay, that's a solid method. Let's start with the definition.\n\nThe present tense in Spanish is used to talk about things happening now, or things that happen regularly. For example, \"I speak Spanish\" or \"She runs every day.\"\n\nTo do this, we change the ending of the verb. Spanish verbs in their basic form, called the infinitive, always end in -ar, -er, or -ir. Think of the infinitive as the raw material, like clay, that you shape for a specific purpose.\n\nLet's take an -ar verb like `hablar`, which means \"to speak.\"\nTo say \"I speak,\" you drop the -ar and add an -o. So, `hablar` becomes `hablo`.\n\nFollowing that pattern, what part of `hablar` do you think stays the same, and what part changes?",
  "signals": {
