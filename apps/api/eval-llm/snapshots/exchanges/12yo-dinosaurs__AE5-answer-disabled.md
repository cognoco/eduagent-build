# Exchanges (main tutoring loop) × 12yo-dinosaurs · AE5-answer-disabled
...
```json
{
  "scenarioId": "AE5-answer-disabled",
  "scenarioPurpose": "Answer-evaluation disabled — the legacy prompt and response must omit signals.answer_evaluation",
  "context": {
...
- Scenario: AE5-answer-disabled — Answer-evaluation disabled — the legacy prompt and response must omit signals.answer_evaluation
