# Exchanges (main tutoring loop) × 15yo-football-gaming · S13-first-session-subject-turn0
...
> **Scenario:** `S13-first-session-subject-turn0`
...
```json
{
  "scenarioId": "S13-first-session-subject-turn0",
  "scenarioPurpose": "Very first subject session turn 0 — subject-level opener wins over topic probe",
  "context": {
...
"Quick - before I dive in: what brought you to Mathematics? Anything specific you want to be able to do?"
...
- Scenario: S13-first-session-subject-turn0 — Very first subject session turn 0 — subject-level opener wins over topic probe
