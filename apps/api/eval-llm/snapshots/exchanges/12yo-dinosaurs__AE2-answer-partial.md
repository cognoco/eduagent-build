# Exchanges (main tutoring loop) × 12yo-dinosaurs · AE2-answer-partial
...
```json
{
  "scenarioId": "AE2-answer-partial",
  "scenarioPurpose": "Answer-evaluation enabled — an incomplete substantive answer to the immediately preceding ordinary question must emit correctness=partial",
  "context": {
...
- Scenario: AE2-answer-partial — Answer-evaluation enabled — an incomplete substantive answer to the immediately preceding ordinary question must emit correctness=partial
