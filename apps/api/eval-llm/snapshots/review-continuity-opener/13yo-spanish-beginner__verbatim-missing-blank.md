# Review-Continuity Opener faithfulness (EU-1/EU-2/EU-4 — LLM judge) × 13yo-spanish-beginner · verbatim-missing-blank
...
> **Scenario:** `verbatim-missing-blank`
...
```json
{
  "scenarioId": "verbatim-missing-blank",
  "description": "self-deprecating non-answer — opener must NOT recite it back to the learner",
  "context": {
  ...
  "exchangeContext": {
    "sessionId": "eval-review-opener-verbatim-missing-blank",
...
<source id="current_topic" kind="current_topic" reliability="trusted_app_content" reliable_for_facts="true" label="Loaded curriculum topic" excerpt="ser vs estar"/>
</source_pack>
...
- Review-continuity opener scenario: verbatim-missing-blank — self-deprecating non-answer — opener must NOT recite it back to the learner
