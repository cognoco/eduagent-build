# Review-Continuity Opener faithfulness (EU-1/EU-2/EU-4 — LLM judge) × 15yo-football-gaming · consent-declined
...
```json
{
  "scenarioId": "consent-declined",
  "description": "consent false — builder must degrade to generic even though retrieval and bullets are present",
  "context": {
    "topicTitle": "algebra equations",
    "consentGranted": false,
    "priorRetrieval": {
      "learnerAnswerVerbatim": "You move the number to the other side and then divide. Like x plus 5 equals 12 so x is 7.",
      "verdict": "solid",
      "daysSince": 3
    },
    "priorSolidCount": 4,
  ...
  "exchangeContext": {
    "sessionId": "eval-review-opener-consent-declined",
...
- Review-continuity opener scenario: consent-declined — consent false — builder must degrade to generic even though retrieval and bullets are present
