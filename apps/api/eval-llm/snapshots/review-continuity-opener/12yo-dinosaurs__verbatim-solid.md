# Review-Continuity Opener faithfulness (EU-1/EU-2/EU-4 — LLM judge) × 12yo-dinosaurs · verbatim-solid
...
```json
{
  "scenarioId": "verbatim-solid",
  "description": "solid prior answer with recap bullets — opener may quote and affirm",
  "context": {
    "topicTitle": "fossilization",
    "consentGranted": true,
    "priorRetrieval": {
      "learnerAnswerVerbatim": "When the animal dies it gets covered by dirt really fast so nothing can eat it. Then over millions of years the bones get replaced by minerals and that's how you get a fossil.",
      "verdict": "solid",
      "daysSince": 6
    },
    "priorSolidCount": 2,
  ...
  "exchangeContext": {
    "sessionId": "eval-review-opener-verbatim-solid",
...
- Review-continuity opener scenario: verbatim-solid — solid prior answer with recap bullets — opener may quote and affirm
