# App help — V2 shell routing × 11yo-czech-animals · memory-to-journal
...
- Must route to: Mentor memory
- Must NOT name: My Notes, More >, Library >, Open Progress, Home >
- Deterministic V2 reply: You can see what the mentor remembers in the Journal tab, under Mentor memory.
