# App help — V2 shell routing × 11yo-czech-animals · subscription-to-account
...
> **Scenario:** `subscription-to-account`
...
- Must route to: Subscription
- Must NOT name: More >, My Notes, More >, Library >, Open Progress, Home >
- Deterministic V2 reply: Your plan and upgrade options are in your Account — tap your profile picture (top-right), then Subscription. For billing problems, open Account, then Help & feedback. I can't quote prices or limits here.
