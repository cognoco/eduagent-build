# App help — V2 shell routing × 11yo-czech-animals · past-sessions-to-journal
...
> **Scenario:** `past-sessions-to-journal`
...
- Deterministic V2 reply: Past conversations are in the Journal tab, under Saved notes (Recent learning sessions).
