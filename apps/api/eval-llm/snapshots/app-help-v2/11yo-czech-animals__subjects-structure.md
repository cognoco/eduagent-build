# App help — V2 shell routing × 11yo-czech-animals · subjects-structure
...
- Must route to: Subjects
- Must NOT name: Library >, My Notes, More >, Library >, Open Progress, Home >
- Deterministic V2 reply: Open the Subjects tab to see your subjects; open a subject to see its books and topics (sometimes grouped into chapters).
