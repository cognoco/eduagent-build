# App help — V2 shell routing × 11yo-czech-animals · add-child-to-account
...
- Must route to: Account
- Must NOT name: More >, Open Progress, My Notes, More >, Library >, Open Progress, Home >
- Deterministic V2 reply: You can add a child by tapping your profile picture (top-right) to open Account, then Family settings, then Add a child (you need to be the adult account owner).
