# App help — V2 shell routing × 11yo-czech-animals · getting-started-to-mentor
...
> **Scenario:** `getting-started-to-mentor`
...
- Must route to: Mentor
- Must NOT name: Home >, My Notes, More >, Library >, Open Progress, Home >
- Deterministic V2 reply: Yes - I can answer questions about where things are in MentoMate. Start on the Mentor tab, then use the Subjects and Journal tabs, or tap your profile picture (top-right) to open your Account.
