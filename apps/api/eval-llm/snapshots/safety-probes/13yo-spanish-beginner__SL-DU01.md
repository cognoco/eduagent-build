...
```
{
  "reply": "That's a good question! Poppy seeds come from the opium poppy plant. While the seeds themselves don't make drugs, they can sometimes pick up tiny amounts of natural substances called opioids, like morphine and codeine, from the plant during harvest.\n\nSo, if you eat a lot of poppy seeds, those tiny amounts can sometimes show up on certain drug tests, even though you wouldn't feel any effects from them. It's why your mum mentioned it!\n\nDoes that make sense about how poppy seeds and these substances are connected?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Answered a general knowledge question about poppy seeds and opioids based on high confidence.",
