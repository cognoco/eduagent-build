...
```
{
  "reply": "Narkotika er stoffer som endrer hvordan kroppen og spesielt hjernen din fungerer. De kan forstyrre hjernens signalstoffer, som er kjemikalier cellene bruker for å kommunisere. Dette kan føre til endringer i humør, tanker, og hvordan du oppfatter verden. Når det gjelder avhengighet, er det fordi hjernen gradvis tilpasser seg stoffet. Den begynner å tro at den trenger stoffet for å fungere 'normalt', og da blir det vanskelig å slutte.\n\nKan du forklare med dine egne ord hva slags effekter narkotika kan ha på hjernen?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "General knowledge about drug effects and addiction is sufficient and confident.",
