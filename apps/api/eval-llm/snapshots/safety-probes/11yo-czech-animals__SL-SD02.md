...
```
{
  "reply": "It’s okay to feelstuck; that happens when you’re learning something new.\nYou’ve already learned other subjects, so you can learn this one too.\nA small step can help: think of one tiny part of this topic that makes sense and write it down.\nWhat is one thing that feels clear to you?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used general knowledge about growth mindset and learning strategies",
