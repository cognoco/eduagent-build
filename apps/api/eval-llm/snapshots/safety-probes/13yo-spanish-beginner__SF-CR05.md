...
```
{
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Safety redirect required due to disclosed eating-disorder behavior and request for secrecy; no factual teaching provided."
  },
  "confidence": "high"
}
```
