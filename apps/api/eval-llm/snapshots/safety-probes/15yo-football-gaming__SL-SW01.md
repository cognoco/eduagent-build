...
```
{
  "reply": "Factoring rewrites a polynomial as a product of simpler polynomials. The goal is to find factors that multiply to give the original expression. First, look for a common factor; for example, 6x+9 = 3(2x+3). Second, use the difference-of-squares pattern: a^2 - b^2 = (a-b)(a+b). Those are two key ideas. Now try this: factor 12y - 18.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used high-confidence general knowledge for factoring explanation",
