...
```
{
  "reply": "Yes, that's exactly right. Quick burial protects the remains from being scattered or broken down before they have a chance to fossilize.\n\nHere's the next question: Why do you think we find many more fossils of sea creatures than land animals?",
  "signals": {
    ...
    "challenge_round_evaluation": [
      {
        ...
        "concept": "Importance of rapid burial for fossilization",
        "result": "solid",
        "learnerQuote": "scavengers and rotting cannot destroy the bones first"
      }
    ]
  },
  "ui_hints": {
