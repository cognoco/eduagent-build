  ...
  "items": [
    {
      ...
      "evidence": "The explanation incorrectly states that proximity to the Sun causes seasonal temperature differences.",
      "learnerQuote": "Earth gets closer to the Sun in summer and farther away in winter",
      "correction": "The seasons change due to the tilt of Earth's axis, not because of its distance from the Sun."
    }
  ]
}
```
