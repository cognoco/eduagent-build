# Interview (diagnostic assessment) × 15yo-football-gaming · subject-book-focus
...
```json
{
  ...
  "bookTitle": "algebra equations",
  "userMessage": "Hi! I want to get better at algebra equations. I'm really into football."
}
```
...
Focus area: <book_title>algebra equations</book_title>
...
```
Hi! I want to get better at algebra equations. I'm really into football.
```

## Builder notes

- Subject: Mathematics
- Book focus: "algebra equations" — exercises the focus-line variant
