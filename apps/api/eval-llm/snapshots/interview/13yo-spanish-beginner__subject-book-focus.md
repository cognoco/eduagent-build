# Interview (diagnostic assessment) × 13yo-spanish-beginner · subject-book-focus
...
```json
{
  ...
  "bookTitle": "Spanish present tense verbs",
  "userMessage": "Hi! I want to get better at Spanish present tense verbs. I'm really into horses."
}
```
...
Focus area: <book_title>Spanish present tense verbs</book_title>
...
```
Hi! I want to get better at Spanish present tense verbs. I'm really into horses.
```

## Builder notes

- Subject: Languages
- Book focus: "Spanish present tense verbs" — exercises the focus-line variant
