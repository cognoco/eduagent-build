# Language-learning intent detection (subject creation) × 11yo-czech-animals · spanish-target-language-practice
...
> **Scenario:** `spanish-target-language-practice`
...
```
<subject_text>I want to practice Spanish conversation</subject_text>
```
