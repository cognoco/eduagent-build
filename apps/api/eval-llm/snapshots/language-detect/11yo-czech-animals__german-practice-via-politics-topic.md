# Language-learning intent detection (subject creation) × 11yo-czech-animals · german-practice-via-politics-topic
...
> **Scenario:** `german-practice-via-politics-topic`
...
```json
{
  "rawInput": "I want to practice German by discussing current German politics",
...
```
<subject_text>I want to practice German by discussing current German politics</subject_text>
```

## Builder notes

- Expected isLanguageLearning: true
