# Language-learning intent detection (subject creation) × 11yo-czech-animals · french-history-ambiguous
...
> **Scenario:** `french-history-ambiguous`
...
```
<subject_text>French Revolution</subject_text>
```
