...
<source id="conversation_history" kind="conversation_history" reliability="conversation_only" reliable_for_facts="false" label="Recent conversation history" excerpt="assistant: We&apos;ve covered a lot today on Mesozoic era. Want to keep going or wrap up with a quick summary? user: Let&apos;s stop — I&apos;m really tired."/>
...
```
{
  "reply": "No problem! It sounds like you're ready for a break. We learned a lot about the Mesozoic Era today.\n\nWant to put down what you learned today?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "User requested to stop and end the session. Offering to capture learning for the session. Server inferred current_topic because the reply explicitly used the loaded topic title."
  },
  "confidence": "high"
}
```
