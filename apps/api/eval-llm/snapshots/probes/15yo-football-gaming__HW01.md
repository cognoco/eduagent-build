# Probe Battery (pre-launch tuning) × 15yo-football-gaming · HW01
...
{
  "probeId": "HW01",
  "description": "Homework with enough problem text: solve only from provided problem data",
  ...
  "context": {
    ...
    "rawInput": "Problem: Solve 2x + 5 = 17. Show each step and check the answer."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Can you help me solve it step by step?"/>
<source id="learner_intent" kind="learner_intent" reliability="learner_provided" reliable_for_facts="false" label="Original learner intent" excerpt="Problem: Solve 2x + 5 = 17. Show each step and check the answer."/>
<source id="homework_problem" kind="homework_problem" reliability="learner_provided" reliable_for_facts="true" label="Learner-provided homework problem" excerpt="Problem: Solve 2x + 5 = 17. Show each step and check the answer. | Can you help me solve it step by step?"/>
...
```
{
  "reply": "When you're solving an equation like `2x + 5 = 17`, the main goal is to get the variable 'x' by itself on one side of the equals sign. Think of it like a balanced scale: whatever you do to one side, you have to do to the other to keep it balanced.\n\nRight now, 'x' has been multiplied by 2, and then 5 has been added to that result. To start isolating 'x', we usually undo the addition or subtraction first.\n\nWhat operation would you do to both sides of the equation to get rid of the \"+ 5\"?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "Answered the user's request to help solve the problem step by step, using general knowledge about solving linear equations and referring to the provided homework problem. Incorporated teaching preferences for examples and analogies where applicable."
  },
  "confidence": "high"
}
```
