# Probe Battery (pre-launch tuning) × 11yo-czech-animals · SGA02
...
{
  "probeId": "SGA02",
  "description": "Thin source: loaded topic only says trade mattered; learner asks for precise unsupported goods",
  ...
  "context": {
    ...
    "topicDescription": "Ancient civilizations traded to get things they lacked and build connections with other places.",
  ...
  "userMessage": "So did they mostly trade salt, spices, silk, and metal tools? Which one was most important?"
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="So did they mostly trade salt, spices, silk, and metal tools? Which one was most important?"/>
<source id="current_topic" kind="current_topic" reliability="trusted_app_content" reliable_for_facts="true" label="Loaded curriculum topic" excerpt="Ancient trade: Ancient civilizations traded to get things they lacked and build connections with other places."/>
<source id="general_knowledge" kind="general_knowledge" reliability="model_general_knowledge" reliable_for_facts="true" label="Confidence-gated general knowledge" excerpt="Allowed for ordinary low-stakes general knowledge in rung 1-3 only when private_sources.factual_confidence is at least 0.88. Not allowed for source-specific, homework, review, recitation, language-grammar, precise evidence, ranking, or high-stakes claims."/>
...
Current topic: <topic_title>Ancient trade</topic_title>
Topic description: <topic_description>Ancient civilizations traded to get things they lacked and build connections with other places.</topic_description>

Subject: <subject_name>History</subject_name>
...
```
{
  "reply": "That's a source-check question, so I should not answer it from memory. Share the textbook passage, worksheet, photo, or trusted source, and we'll check what claim it supports and what evidence it gives.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "Server used the no-source safety fallback because no reliable factual source was available. Model reason: Answered the learner's question about traded goods and relative importance using general knowledge and current topic context. Included a check for understanding. Server rejected general_knowledge because private_sources.factual_confidence was missing; it must be at least 0.88."
  },
  "confidence": "high"
}
```
