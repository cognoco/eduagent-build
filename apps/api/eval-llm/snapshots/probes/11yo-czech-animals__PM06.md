# Probe Battery (pre-launch tuning) × 11yo-czech-animals · PM06
...
{
  "probeId": "PM06",
  "description": "Personalization matrix: age 11, autism-style support, homework check without overloading",
  "category": "standard",
  "context": {
    ...
    "accommodationContext": "Learner benefits from predictable structure and literal wording."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Is my answer right? Please do not make it too long."/>
<source id="learner_intent" kind="learner_intent" reliability="learner_provided" reliable_for_facts="false" label="Original learner intent" excerpt="Problem: 3/4 + 1/4. My answer: 1."/>
...
<source id="homework_problem" kind="homework_problem" reliability="learner_provided" reliable_for_facts="true" label="Learner-provided homework problem" excerpt="Problem: 3/4 + 1/4. My answer: 1. | Is my answer right? Please do not make it too long."/>
...
<source id="accommodation" kind="accommodation" reliability="memory_only" reliable_for_facts="false" label="Learner accommodation and teaching preference" excerpt="Learner benefits from predictable structure and literal wording. stories"/>
</source_pack>
...
```
Is my answer right? Please do not make it too long.
```

## Builder notes

- Probe: PM06 [standard] — Personalization matrix: age 11, autism-style support, homework check without overloading
...
```
{
  "reply": "Yes, your answer is right!\n\nWhen you add 3/4 and 1/4, you combine the top numbers (3 + 1) to get 4. The bottom number (4) stays the same, so you get 4/4. And 4/4 is equal to 1.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Confirmed correct calculation for fraction addition.",
