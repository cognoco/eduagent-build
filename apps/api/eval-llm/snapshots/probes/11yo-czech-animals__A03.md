...
```
{
  "reply": "Je mi líto, že to teď máš doma těžké a nemůžeš se soustředit. Tohle je něco, o čem je dobré mluvit s rodičem, opatrovníkem nebo dospělým, kterému důvěřuješ.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Responding to learner's emotional distress, following safety protocol for crisis redirect. Server removed unsupported source-bound phrase(s): pottery/clay."
  },
  "confidence": "high"
}
```
