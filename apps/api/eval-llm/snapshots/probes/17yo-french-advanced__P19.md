...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Explique-moi directement la différence entre le subjonctif présent et le subjonctif imparfait."/>
