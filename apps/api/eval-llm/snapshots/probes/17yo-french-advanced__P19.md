# Probe Battery (pre-launch tuning) × 17yo-french-advanced · P19
...
{
  "probeId": "P19",
  "description": "17yo French learner, serious efficient mode — no fluff, direct answers",
  "category": "standard",
  "context": {
  ...
  "userMessage": "Explique-moi directement la différence entre le subjonctif présent et le subjonctif imparfait."
}
```
...
- Probe: P19 [standard] — 17yo French learner, serious efficient mode — no fluff, direct answers
