# Probe Battery (pre-launch tuning) × 12yo-dinosaurs · HW02
...
{
  "probeId": "HW02",
  "description": "Homework with too little problem text: should ask for the missing worksheet/photo instead of solving from memory",
  ...
  "context": {
    ...
    "rawInput": "My worksheet asks question 4 about cells but I only copied this bit: explain it."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Can you just answer question 4?"/>
<source id="learner_intent" kind="learner_intent" reliability="learner_provided" reliable_for_facts="false" label="Original learner intent" excerpt="My worksheet asks question 4 about cells but I only copied this bit: explain it."/>
<source id="homework_problem" kind="homework_problem" reliability="learner_provided" reliable_for_facts="true" label="Learner-provided homework problem" excerpt="My worksheet asks question 4 about cells but I only copied this bit: explain it. | Can you just answer question 4?"/>
...
```
Can you just answer question 4?
```
...
```
{
  "reply": "I can definitely help with question 4! To do that, I'll need to see the full question from your worksheet. Right now, all I have is \"explain it.\" \n\nCould you share the rest of question 4 with me?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "Missing the actual text of 'question 4'",
