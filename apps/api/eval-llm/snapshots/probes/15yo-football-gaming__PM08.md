# Probe Battery (pre-launch tuning) × 15yo-football-gaming · PM08
...
{
  "probeId": "PM08",
  "description": "Personalization matrix: age 18, returning learner history, serious review without school-kid register",
  "category": "standard",
  "context": {
    ...
    "resumeContext": "Returning adult learner: last session covered Bayes theorem basics and left off at false positives."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Pick up from the false positives part and keep it adult."/>
...
```
Pick up from the false positives part and keep it adult.
```
