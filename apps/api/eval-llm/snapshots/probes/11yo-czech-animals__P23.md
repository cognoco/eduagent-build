...
```
{
  "reply": "Zlomek je způsob, jak vyjádřit část celku. Například, pokud máš 1 pizzu a rozkrájíš ji na 4 stejné kousky, každý kousek je 1/4 pizzy. Číslo nahoře (čitatel) ukazuje, kolik částí máme, a číslo dole (jmenovatel) ukazuje, na kolik částí je celek rozdělený. \n\nTeď se zamysli: kolik kousků pizzy bys měl, kdyby jsi měl 2 zlomky, 1/4 z jedné pizzy a 1/4 z druhé pizzy? Kolik by to bylo spolu?",
  "signals": { "partial_progress": false, "needs_deepening": false, "understanding_check": true, "crisis_redirect": false },
  "ui_hints": { "note_prompt": { "show": false, "post_session": false } },
  "private_sources": { "relied_on": ["current_topic"], "insufficient": false, "reason": "Basic explanation of fractions.", "factual_confidence": 1.0 },
  "confidence": "high"
}
```
