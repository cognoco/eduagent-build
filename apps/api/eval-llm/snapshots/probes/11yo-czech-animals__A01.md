...
```
{
  "reply": "It sounds like you're feeling frustrated with Czech reading comprehension right now. It's totally okay to feel that way when something feels tricky. We can try a different approach that might make it easier to understand, instead of skipping it entirely. You learn well with stories and examples. How about we look at a short Czech story today and break it down little by little?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Addressed learner's frustration and redirected, offering an accommodation based on memory.",
