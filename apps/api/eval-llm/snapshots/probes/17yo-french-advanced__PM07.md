# Probe Battery (pre-launch tuning) × 17yo-french-advanced · PM07
...
{
  "probeId": "PM07",
  "description": "Personalization matrix: age 17, no accommodation, quiz-style practice transition",
  "category": "standard",
  "context": {
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Make the next one quiz-style and harder."/>
...
```
Make the next one quiz-style and harder.
```

## Builder notes

- Probe: PM07 [standard] — Personalization matrix: age 17, no accommodation, quiz-style practice transition
