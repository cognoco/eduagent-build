# Probe Battery (pre-launch tuning) × 12yo-dinosaurs · P17
...
{
  "probeId": "P17",
  "description": "12yo dinosaur fan in Feynman teach-back mode (rung 4, teach_back)",
  "category": "standard",
  "context": {
  ...
  "userMessage": "Okay so fossilization is basically when an animal dies and gets buried really fast, then minerals slowly replace the bones over millions of years."
}
```
...
```
{
  "reply": "That's a good start! Can you tell me more about how the environment affects fossilization? Like, does it matter what kind of place the animal is buried in?",
  "signals": {
    ...
    "teach_back_assessment": {
      ...
      "gap_identified": "The explanation only covers bone permineralization and omits other key steps (soft tissue decay, sediment layers, compression) and other types of fossilization such as molds, casts, amber preservation, or trace fossils."
    }
  },
  "ui_hints": {
    "note_prompt": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Checking if learner can explain more about the environmental conditions that affect fossilization beyond the basic process description."
  },
  "confidence": "high"
}
```
