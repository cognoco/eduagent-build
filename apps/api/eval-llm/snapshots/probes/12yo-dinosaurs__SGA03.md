...
```
{
  "reply": "Fossils are like ancient clues to life from a long, long time ago! We call that \"sediment. So, based on what we just talked about, what are two important things that need to happen for a fossil to form?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Explained fossil formation based on provided current_topic and asked a check question. Server removed unsupported source-bound phrase(s): unsupported sediment definition."
  },
  "confidence": "high"
}
```
