# Probe Battery (pre-launch tuning) × 12yo-dinosaurs · SGA03
...
{
  "probeId": "SGA03",
  "description": "Reliable source: current topic supports a narrow factual answer and should be used without adding extras",
  ...
  "context": {
    ...
    "topicDescription": "Fossils often form when remains are buried by sediment. Over time, minerals can replace hard parts such as bones or shells, preserving their shape.",
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Can you explain how fossils form from this source?"/>
<source id="current_topic" kind="current_topic" reliability="trusted_app_content" reliable_for_facts="true" label="Loaded curriculum topic" excerpt="Fossilization basics: Fossils often form when remains are buried by sediment. Over time, minerals can replace hard parts such as bones or shells, preserving their shape."/>
...
Current topic: <topic_title>Fossilization basics</topic_title>
Topic description: <topic_description>Fossils often form when remains are buried by sediment. Over time, minerals can replace hard parts such as bones or shells, preserving their shape.</topic_description>
...
```
{
  "reply": "Fossils usually start to form when the remains of an animal or plant, like bones or shells, get buried under layers of sediment. Then, over a very long time, special minerals in the ground can slowly replace those hard parts, changing them into rock and keeping their original shape. What are the two main things that need to happen for a fossil to form?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used current_topic for explanation of fossilization. Server removed unsupported source-bound phrase(s): unsupported sediment definition."
  },
  "confidence": "high"
}
```
