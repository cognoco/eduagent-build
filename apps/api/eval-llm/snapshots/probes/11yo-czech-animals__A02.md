...
```
{
  "reply": "It's perfectly normal to find some things challenging — it doesn’t mean you’re not capable. Sometimes it just takes a different way of looking at it. Would you like to go over some Czech reading comprehension concepts together? We can use stories to help explain, since that works well for you.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "The learner expressed ordinary academic frustration, not a crisis-level concern. Server inferred current_topic because the reply explicitly used the loaded topic title."
  },
  "confidence": "high"
}
```
