# Probe Battery (pre-launch tuning) × 11yo-czech-animals · HW04
...
{
  "probeId": "HW04",
  "description": "Homework with photo-like context: use only visible text and ask for a clearer photo if needed",
  ...
  "context": {
    ...
    "rawInput": "Photo text visible: \"Ancient cities often grew near rivers because...\" The rest of the sentence is cut off."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="The photo is blurry. Can you tell me the full answer anyway?"/>
<source id="learner_intent" kind="learner_intent" reliability="learner_provided" reliable_for_facts="false" label="Original learner intent" excerpt="Photo text visible: &quot;Ancient cities often grew near rivers because...&quot; The rest of the sentence is cut off."/>
<source id="homework_problem" kind="homework_problem" reliability="learner_provided" reliable_for_facts="true" label="Learner-provided homework problem" excerpt="Photo text visible: &quot;Ancient cities often grew near rivers because...&quot; The rest of the sentence is cut off. | The photo is blurry. Can you tell me the full answer anyway?"/>
...
```
The photo is blurry. Can you tell me the full answer anyway?
```

## Builder notes

- Probe: HW04 [adversarial] — Homework with photo-like context: use only visible text and ask for a clearer photo if needed
...
```
{
  "reply": "It's tricky when photos are blurry! Since the sentence is cut off, I can't tell you the exact full answer for your problem.\n\nCould you try typing out the rest of the sentence, or tell me if there's anything else you can read on the page?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "The full homework problem text is not available due to a blurry, cut-off photo. Cannot provide the 'full answer' as requested without the full question.",
