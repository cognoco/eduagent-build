# Probe Battery (pre-launch tuning) × 15yo-football-gaming · SGA07
...
{
  "probeId": "SGA07",
  "description": "WI-2100: freeform session, learner references an unnamed book by an unnamed author (\"her book\") — must ask which book, not assume one",
  ...
  "userMessage": "I'm reading her book for my English assignment but I haven't started writing anything yet. Can you help me figure out what to say about the main character?"
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="I&apos;m reading her book for my English assignment but I haven&apos;t started writing anything yet. Can you help me figure out what to say about the main character?"/>
...
- Probe: SGA07 [adversarial] — WI-2100: freeform session, learner references an unnamed book by an unnamed author ("her book") — must ask which book, not assume one
