# Probe Battery (pre-launch tuning) × 11yo-czech-animals · P01
...
{
  "probeId": "P01",
  "description": "11yo Czech girl encounters a brand-new topic for the first time (rung 1, Czech)",
  "category": "standard",
  "context": {
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Vůbec tomu nerozumím. Můžeš mi to vysvětlit od začátku?"/>
...
```
Vůbec tomu nerozumím. Můžeš mi to vysvětlit od začátku?
```

## Builder notes

- Probe: P01 [standard] — 11yo Czech girl encounters a brand-new topic for the first time (rung 1, Czech)
...
```
{"reply":"Jasně, pojďme to vzít od začátku. Pochopení textu v češtině znamená porozumět slovům a větám, které čteme. Je dobré začít tím, jaké jsou hlavní myšlenky a jaké detaily text obsahuje. Když čteme příběh, můžeme se ptát, kdo jsou hlavní postavy, co se stane a proč.\n\nNapříklad, pokud čteme příběh o lese, mohli bychom se ptát: Kdo je v příběhu? Co se v lese děje? Jaké zvíře je důležité pro tento příběh? Tyto otázky nám pomáhají lépe porozumět textu. \n\nNa začátek, chceš se podívat na nějaký konkrétní text nebo příběh, který bys rád pochopil lépe?","signals":{ "partial_progress":false, "needs_deepening":false, "understanding_check":true, "crisis_redirect":false }, "ui_hints":{ "note_prompt":{ "show":false, "post_session":false } }, "private_sources":{ "relied_on":["current_topic"], "insufficient":false, "reason":"Just starting the topic on reading comprehension.","factual_confidence":1.0 }, "confidence":"high"}
```
