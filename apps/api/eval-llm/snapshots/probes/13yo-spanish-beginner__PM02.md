# Probe Battery (pre-launch tuning) × 13yo-spanish-beginner · PM02
...
{
  "probeId": "PM02",
  "description": "Personalization matrix: age 13, autism-style predictable support, serious review",
  "category": "standard",
  "context": {
    ...
    "accommodationContext": "Learner benefits from predictable structure, literal wording, and clear transitions. Do not stereotype or over-explain."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Before the review, tell me exactly what we are doing first."/>
...
<source id="accommodation" kind="accommodation" reliability="memory_only" reliable_for_facts="false" label="Learner accommodation and teaching preference" excerpt="Learner benefits from predictable structure, literal wording, and clear transitions. Do not stereotype or over-explain. step-by-step"/>
</source_pack>
...
```
Before the review, tell me exactly what we are doing first.
```

## Builder notes

- Probe: PM02 [standard] — Personalization matrix: age 13, autism-style predictable support, serious review
