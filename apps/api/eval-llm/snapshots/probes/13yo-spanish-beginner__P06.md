# Probe Battery (pre-launch tuning) × 13yo-spanish-beginner · P06
...
{
  "probeId": "P06",
  "description": "13yo Spanish learner on text mode — no pronunciation coaching expected",
  "category": "standard",
  "context": {
  ...
  "userMessage": "Can you show me a worked example of ser vs estar in a sentence about family?"
}
```
...
- Probe: P06 [standard] — 13yo Spanish learner on text mode — no pronunciation coaching expected
