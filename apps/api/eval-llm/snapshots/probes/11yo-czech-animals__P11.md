...
```
{
  "reply": "No problem at all! We covered a lot today with Czech reading comprehension.\n\nWant to put down what you learned today?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Learner wants to stop, confirming the end of the session and offering to summarize/capture learning.",
