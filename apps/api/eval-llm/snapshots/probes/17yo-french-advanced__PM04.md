# Probe Battery (pre-launch tuning) × 17yo-french-advanced · PM04
...
{
  "probeId": "PM04",
  "description": "Personalization matrix: age 18 adult learner, no accommodation, casual free chat without childish tone",
  "category": "standard",
  "context": {
  ...
  "userMessage": "I am 18 and just want a relaxed warm-up before studying. Keep it natural."
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="I am 18 and just want a relaxed warm-up before studying. Keep it natural."/>
...
- sourceEvidence: learner_message:context, general_knowledge:reliable, prior_learning:context, mentor_memory:context, accommodation:context
