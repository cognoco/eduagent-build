...
```
{
  "reply": "I don't have reliable source material for that yet, so I won't invent the facts. What I can safely do now is frame your question: \"I am back. Can we continue but keep it short?\" Share the textbook passage, worksheet, photo, or trusted source, and I'll help turn it into a clear answer with evidence.",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "Server used the no-source safety fallback because no reliable factual source was available. Model reason: Continuing the lesson on Czech reading comprehension, explaining inflection based on general knowledge and previous session's topic. Server rejected general_knowledge because private_sources.factual_confidence was missing; it must be at least 0.88."
  },
  "confidence": "high"
}
```
