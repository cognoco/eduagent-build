# Probe Battery (pre-launch tuning) × 11yo-czech-animals · PM01
...
{
  "probeId": "PM01",
  "description": "Personalization matrix: age 11, ADHD-style short-burst support, serious study, returning learner",
  "category": "standard",
  "context": {
    "sessionId": "eval-probe-11yo-czech-animals",
    ...
    "exchangeHistory": [
      {
        "role": "assistant",
        "content": "Welcome back! Last time we wrapped up an overview of Czech reading comprehension. Want to pick up where we left off, or review the summary first?"
      },
      {
        "role": "user",
    ...
    "inputMode": "text",
    "llmTier": "standard",
    "accommodationContext": "Learner benefits from ADHD-friendly short bursts: one step at a time, low clutter, and quick check-ins.",
    "resumeContext": "Returning learner: last time they understood the example but lost focus during the second step."
  },
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="I am back. Can we continue but keep it short?"/>
...
<source id="conversation_history" kind="conversation_history" reliability="conversation_only" reliable_for_facts="false" label="Recent conversation history" excerpt="assistant: Welcome back! Last time we wrapped up an overview of Czech reading comprehension. Want to pick up where we left off, or review the summary first? user: Let&apos;s just continue — I remember the basics."/>
<source id="prior_learning" kind="prior_learning" reliability="memory_only" reliable_for_facts="false" label="Prior learning summary" excerpt="Recently completed topics: basic fractions, human body systems. Demonstrated strength in: vocabulary retention."/>
<source id="mentor_memory" kind="mentor_memory" reliability="memory_only" reliable_for_facts="false" label="Mentor memory and summaries" excerpt="Recent semantically-similar session: learner was working on Czech reading comprehension and had trouble with fraction addition. They responded well to stories-based explanations. About this learner: - Confident with: vocabulary retention (Czech). - They learn best with stories and examples-based explanations, a step-by-step pace. - School interests: drawing..."/>
<source id="accommodation" kind="accommodation" reliability="memory_only" reliable_for_facts="false" label="Learner accommodation and teaching preference" excerpt="Learner benefits from ADHD-friendly short bursts: one step at a time, low clutter, and quick check-ins. stories"/>
</source_pack>
...
```
I am back. Can we continue but keep it short?
```

## Builder notes

- Probe: PM01 [standard] — Personalization matrix: age 11, ADHD-style short-burst support, serious study, returning learner
...
- **WARNING PM01.structure:** Accommodation scenario should show lightweight structure or short-burst pacing.

## Live LLM response

```
{"reply":"Of course! Let's dive back into Czech reading comprehension. One important part of reading comprehension is understanding the main idea of a text. The main idea is what the text is mostly about. Another key point is identifying supporting details, which are examples or facts that explain or add to the main idea. \n\nCan you tell me what the main idea means in your own words?","signals":{"partial_progress":false,"needs_deepening":false,"understanding_check":true,"crisis_redirect":false},"ui_hints":{"note_prompt":{"show":false,"post_session":false}},"private_sources":{"relied_on":["current_topic"],"insufficient":false,"reason":"Loaded topic on Czech reading comprehension has been utilized.","factual_confidence":1.0},"confidence":"high"}
```
