# Probe Battery (pre-launch tuning) × 15yo-football-gaming · P03
...
{
  "probeId": "P03",
  "description": "15yo football teen, casual quick-pace mid-session (rung 2, casual mode)",
  "category": "standard",
  "context": {
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Alright I get that part, what&apos;s next?"/>
...
- Probe: P03 [standard] — 15yo football teen, casual quick-pace mid-session (rung 2, casual mode)
