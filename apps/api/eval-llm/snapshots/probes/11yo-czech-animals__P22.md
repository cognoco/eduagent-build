...
```
{
  ...
  "private_sources": {
    ...
    "insufficient": true,
    "reason": "Server used the no-source safety fallback because no reliable factual source was available. Model reason: The user requested a more challenging task. I created a short, relevant text and an inferential question based on my general knowledge of the Czech language and common animal behaviors, aligning with the user's stated interests. Server rejected general_knowledge because private_sources.factual_confidence was missing; it must be at least 0.88."
  },
  "confidence": "high"
}
```
