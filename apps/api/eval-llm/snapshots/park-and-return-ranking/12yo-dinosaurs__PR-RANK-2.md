# Park and Return Ranking × 12yo-dinosaurs · PR-RANK-2
...
```json
{
  ...
  "purpose": "A fresh parked item can lose the top-three slots, but it must remain reachable through overflow.",
  "candidates": [
    {
    ...
    },
    {
      ...
      "sortAt": "2026-06-19T12:00:00.000Z",
...
- Scenario: PR-RANK-2 - A fresh parked item can lose the top-three slots, but it must remain reachable through overflow.
- Candidates: unfinished-session, retention-due, ordinary-deepening, challenge-ready, fresh-parked
- Ranked: unfinished-session, retention-due, ordinary-deepening, challenge-ready, fresh-parked
- Cards: unfinished-session, retention-due, ordinary-deepening
- Overflow: challenge-ready, fresh-parked
