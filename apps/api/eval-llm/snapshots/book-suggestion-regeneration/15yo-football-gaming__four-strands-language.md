# Book Suggestion Regeneration × 15yo-football-gaming · four-strands-language
...
The subject is a language-learning subject. The learner is studying French.

Language-specific rules:
- Suggestions should be practice lanes inside French, not generic school subjects or the language name by itself.
...
```
<subject_name>French Four Strands practice</subject_name>
Target language: <target_language>French</target_language>
