# Conversation-Language Quality (cs/nb/pl — LLM judge) × 15yo-football-gaming · LQ-NB01
...
```json
{
  ...
  "userMessage": "Kan du forklare hvorfor månen har faser? Jeg skjønner det ikke helt.",
  "learnerAge": 15
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Kan du forklare hvorfor månen har faser? Jeg skjønner det ikke helt."/>
