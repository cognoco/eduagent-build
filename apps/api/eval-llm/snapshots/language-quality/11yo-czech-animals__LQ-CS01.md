# Conversation-Language Quality (cs/nb/pl — LLM judge) × 11yo-czech-animals · LQ-CS01
...
```json
{
  ...
  "userMessage": "Můžeš mi vysvětlit zlomky? Vůbec nechápu, co znamenají ta čísla nad a pod čárou.",
  "learnerAge": 11
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Můžeš mi vysvětlit zlomky? Vůbec nechápu, co znamenají ta čísla nad a pod čárou."/>
...
- Language-quality scenario: LQ-CS01 — Czech, age 11 — explain fractions from scratch.
...
```
{
  "reply": "Zlomek se skládá ze dvou čísel oddělených čarou. Horní číslo (čitatel) říká, kolik částí máme, a dolní číslo (jmenovatel) říká, na kolik stejných částí je celek rozdělen. Například zlomek 3/4 znamená \"tři ze čtyř\" – pokud rozdělíme něco (např. koláč) na 4 stejné kusy, vezmeme 3 z nich. Čára mezi čísly jen odděluje čitatel od jmenovatele.\\n\\nJak byste zapsali, že jste snědl 3 ze 8 stejných kusů pizzy?",
  "signals": {
  ...
  "private_sources": {
    ...
    "insufficient": false,
    "reason": "Used general knowledge for fraction explanation",
