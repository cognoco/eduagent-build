# Conversation-Language Quality (cs/nb/pl — LLM judge) × 13yo-spanish-beginner · LQ-PL02
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Dlaczego niebo jest niebieskie? Zawsze chciałem to wiedzieć."/>
...
```
Dlaczego niebo jest niebieskie? Zawsze chciałem to wiedzieć.
```
