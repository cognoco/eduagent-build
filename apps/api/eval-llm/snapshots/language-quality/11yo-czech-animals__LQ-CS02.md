# Conversation-Language Quality (cs/nb/pl — LLM judge) × 11yo-czech-animals · LQ-CS02
...
```json
{
  ...
  "userMessage": "Proč některá zvířata v zimě spí? Jak medvěd vydrží tak dlouho bez jídla?",
  "learnerAge": 11
}
```
...
<source_pack>
<source id="learner_message" kind="learner_message" reliability="learner_provided" reliable_for_facts="false" label="Current learner message" excerpt="Proč některá zvířata v zimě spí? Jak medvěd vydrží tak dlouho bez jídla?"/>
