# Progress Summary (parent current-state header) × 11yo-czech-animals · active-child
...
<subjects>
- Czech; 4 sessions; 95 active minutes; 3/7 topics mastered; last studied 2026-05-13T09:00:00Z
...
```
Emma has completed 6 sessions, mastered 4 topics, and has a 3-day streak, accumulating 140 active minutes. Her most recent session today was in Czech, where she has now mastered 3 of 7 topics; continuing with her math activities, where 1 of 4 topics is mastered, could be a gentle next step.
```
