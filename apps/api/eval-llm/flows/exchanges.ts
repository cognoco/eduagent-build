...
const SCENARIO_SPECS: readonly ScenarioSpec[] = [
  ...
  {
    id: 'S15a-review-callback-cracked',
    purpose:
      'Warm review-callback opener (RR-1) — cracked branch: "has it stuck?" framing, private quote grounding (never quoted verbatim)',
    history: [],
    contextOverrides: {
      escalationRung: 1,
      sessionType: 'learning',
  ...
  {
    id: 'S15b-review-callback-wobbled',
    purpose:
      'Warm review-callback opener (RR-1) — wobbled branch: "pick up where it got shaky", no quote, no success claim',
    history: [],
    contextOverrides: {
      escalationRung: 1,
      sessionType: 'learning',
  ...
  {
    id: 'S15c-review-callback-long-gap',
    purpose:
      'Warm review-callback opener (RR-1) — long_gap branch: gentle "it has been a while", no outcome claim',
    history: [],
    contextOverrides: {
      escalationRung: 1,
      sessionType: 'learning',
      ...
      exchangeCount: 0,
      effectiveMode: 'review',
      retentionStatus: { status: 'fading', daysSinceLastReview: 40 },
      reviewCallback: {
  ...
  {
    id: 'S15d-review-callback-unknown',
    purpose:
      'Warm review-callback opener (RR-1) — unknown branch: safe neutral "circle back", no claim about the past',
    history: [],
    contextOverrides: {
      escalationRung: 1,
      sessionType: 'learning',
