...
ALTER TABLE "topic_notes" ALTER COLUMN "artifact_source" SET NOT NULL;--> statement-breakpoint
...
CREATE INDEX "evidence_links_profile_to_idx" ON "evidence_links" USING btree ("profile_id","to_kind","to_id");
--> statement-breakpoint
ALTER TABLE "topic_notes" ADD CONSTRAINT "topic_notes_artifact_source_check" CHECK ("artifact_source" IN ('challenge_solid_quote', 'challenge_drafted_note', 'learner_authored_note', 'freeform_keep'));--> statement-breakpoint
...
ALTER TABLE "evidence_links" ADD CONSTRAINT "evidence_links_from_kind_check" CHECK ("from_kind" = 'artifact');--> statement-breakpoint
ALTER TABLE "evidence_links" ADD CONSTRAINT "evidence_links_to_kind_check" CHECK ("to_kind" = 'transcript_excerpt');
