...
-- pedagogy epic but never had a migration generated. Dev/staging may already
-- have some objects from `drizzle-kit push`, so every statement is idempotent.

-- Step 1: Create new enum types (idempotent via exception handler)
DO $$ BEGIN
...
ALTER TABLE "subjects" ADD COLUMN IF NOT EXISTS "pedagogy_mode" "pedagogy_mode" DEFAULT 'socratic' NOT NULL;
--> statement-breakpoint
ALTER TABLE "subjects" ADD COLUMN IF NOT EXISTS "language_code" text;
--> statement-breakpoint
ALTER TABLE "subjects" ADD COLUMN IF NOT EXISTS "urgency_boost_until" timestamp with time zone;
--> statement-breakpoint
ALTER TABLE "subjects" ADD COLUMN IF NOT EXISTS "urgency_boost_reason" text;
--> statement-breakpoint
...
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "book_id" uuid;
--> statement-breakpoint
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "chapter" text;
--> statement-breakpoint
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "cefr_level" text;
--> statement-breakpoint
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "cefr_sublevel" text;
--> statement-breakpoint
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "target_word_count" integer;
--> statement-breakpoint
ALTER TABLE "curriculum_topics" ADD COLUMN IF NOT EXISTS "target_chunk_count" integer;
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS "vocabulary_retention_cards" (
	"id" uuid PRIMARY KEY NOT NULL,
	"profile_id" uuid NOT NULL,
...
-- Step 7: Add foreign keys (idempotent via exception handler)
DO $$ BEGIN
