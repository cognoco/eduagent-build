...
- Epics 0-5: full API layer (~1,729 API tests + ~701 mobile tests + 16 integration test suites, all passing)
...
- Mobile: 38+ screens (78 test suites), all using real API calls via TanStack Query + Hono RPC
