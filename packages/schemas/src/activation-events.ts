 ...
 * client-observed — app_opened, day2_return, review_card_seen,
 * review_card_tapped — and that may fire before a profile exists.
 * Server-side touchpoints (signup, onboarding, session start/complete) are
 * NOT sent through this route; they are recorded directly by the route/
 * service that owns that transition.
 */
