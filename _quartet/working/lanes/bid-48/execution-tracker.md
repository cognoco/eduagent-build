...
- WI-2790 source-repair PR #2733 passed the governed gate and landed as `70411272`.
  ...
  hosted CI/review are green except for the legacy onboarding smoke. Its one bounded
  rerun reproduced the identical two 60-second signed-in-readiness expirations; the
  executor confirmed this is the already-admitted WI-2826 dependency, not a new
  finding. PR #2741 remains draft and red until WI-2826 supplies the missing hosted
  discriminator and a fresh smoke reaches strict green. No DB connection occurred;
  real live bootstrap remains explicitly operator-gated.
