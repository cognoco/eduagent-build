...
query at `2026-07-24T14:35:08Z`: eight rows, `has_more=false`. Re-query before
acting.
...
| [WI-2717 — Route the daily LLM-volume threshold signal into an alertable production sink](https://www.notion.so/3a78bce91f7c81118c70db2e05bef41e) | Item | Executing/Active; `codex:builder:WI-2717-r1`; workspace recorded as `cognoco/eduagent-build@main`, violating the mandatory Builder worktree boundary | Live AC/discussion; Adversarial review tier; hard prerequisite for WI-2706 and WI-1588; no implementation from the recorded shared checkout is valid | Shepherd stops further implementation, applies the sanctioned claim/worktree recovery path, and re-establishes the Builder in `.worktrees/WI-2717`; only then may the Builder implement and return landed/deployment/synthetic evidence |
...
- WI-2717's live claim records the shared `@main` checkout rather than its
  mandatory `.worktrees/WI-2717` boundary. Stop that dispatch and recover it
  before accepting any implementation, commit, or hand-back.
...
At `2026-07-24T14:35:08Z`, WI-2686, WI-2704, WI-2706, and WI-2717 have live
...
transport evidence exists. WI-2717's recorded shared-checkout claim requires
worktree recovery before its execution can continue. The next lane checkpoint
