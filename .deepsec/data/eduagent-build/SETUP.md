# Agent setup for `eduagent-build`

This is a deepsec scanning workspace. Project `eduagent-build` was just registered
(target: `..`). Setup is incomplete — `data/eduagent-build/INFO.md`
...
2. **Fill in `data/eduagent-build/INFO.md`.** It's auto-injected into the AI
...
```bash
pnpm deepsec scan    --project-id eduagent-build
pnpm deepsec process --project-id eduagent-build
```
