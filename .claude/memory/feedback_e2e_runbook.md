...
description: Before troubleshooting Maestro/emulator/Android issues, consult docs/E2Edocs/e2e-runbook.md. The 2026-04-30 empirical state snapshot at docs/E2Edocs/e2e-2026-04-30-empirical-state.md captures what was last verified working.
type: feedback
---
...
read `docs/E2Edocs/e2e-runbook.md` BEFORE attempting fixes. The runbook is
short (under 400 lines) and covers the canonical pipeline.

For deeper context on what was verified vs. what was disproven, see the
empirical-state snapshot at `docs/E2Edocs/e2e-2026-04-30-empirical-state.md`.
...
3. The canonical entry point for running flows is
   ...
   (which is currently broken — see runbook for details).
