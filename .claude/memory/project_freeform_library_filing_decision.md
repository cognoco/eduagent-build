...
**Decision source:** [`MMT-ADR-0019`](../../docs/adr/MMT-ADR-0019-freeform-library-filing-threshold.md), with the living product rule in [`docs/PRD.md`](../../docs/PRD.md). Use those docs as the source of truth.
...
**How to apply:** If a future change wants to file shorter freeform sessions, add freeform notes, or enable Challenge Round in freeform, treat it as superseding/amending `MMT-ADR-0019`.
