...
The audience matrix is reconstructed historical evidence, not current authority; verify every current-state
claim against `AGENTS.md` and `navigation-contract.ts`.
