...
- [project_freeform_library_filing_decision.md](project_freeform_library_filing_decision.md) — Ask Anything saves sessions by default; bookmarks are instant-save; Library filing starts at 5 exchanges; no freeform Challenge or notes flow.
