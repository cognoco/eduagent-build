---
name: "source-command-bmad-bmad-bmm-retrospective"
description: "Run after epic completion to review overall success, extract lessons learned, and explore if new information emerged that might impact the next epic"
---

# source-command-bmad-bmad-bmm-retrospective

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-retrospective`.
