---
name: "source-command-bmad-bmad-bmm-dev-story"
description: "Execute a story by implementing tasks/subtasks, writing tests, validating, and updating the story file per acceptance criteria"
---

# source-command-bmad-bmad-bmm-dev-story

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-dev-story`.
