---
name: "source-command-bmad-bmad-bmm-document-project"
description: "Analyzes and documents brownfield projects by scanning codebase, architecture, and patterns to create comprehensive reference documentation for AI-assisted development"
---

# source-command-bmad-bmad-bmm-document-project

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-document-project`.
