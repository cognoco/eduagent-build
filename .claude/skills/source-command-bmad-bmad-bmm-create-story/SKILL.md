---
name: "source-command-bmad-bmad-bmm-create-story"
description: "Create the next user story from epics+stories with enhanced context analysis and direct ready-for-dev marking"
---

# source-command-bmad-bmad-bmm-create-story

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-create-story`.
