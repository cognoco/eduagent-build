---
name: "source-command-bmad-bmad-bmm-sprint-status"
description: "Summarize sprint-status.yaml, surface risks, and route to the right implementation workflow."
---

# source-command-bmad-bmad-bmm-sprint-status

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-sprint-status`.
