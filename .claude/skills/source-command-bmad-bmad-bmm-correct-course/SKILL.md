---
name: "source-command-bmad-bmad-bmm-correct-course"
description: "Navigate significant changes during sprint execution by analyzing impact, proposing solutions, and routing for implementation"
---

# source-command-bmad-bmad-bmm-correct-course

Use this skill when the user asks to run the migrated source command `bmad-bmad-bmm-correct-course`.
