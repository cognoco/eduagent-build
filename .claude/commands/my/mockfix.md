...
- **Canonical pattern**: `jest.mock('./module', () => ({ ...jest.requireActual('./module'), specificExport: jest.fn() }))` — spread the real module, override only what the test actually needs to stub.
