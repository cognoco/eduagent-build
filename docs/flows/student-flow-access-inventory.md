> **STATUS (2026-07-14): RETAINED V0/V1 MAP; V2 REFRESH REQUIRED.** Do not treat this as complete current learner access truth. Rebuild against the exact 13+ gate, V2 Mentor/Subjects/Journal shell, current identity/support model, Journal/proof surfaces, and all retained V0/V1 no-regression states.
