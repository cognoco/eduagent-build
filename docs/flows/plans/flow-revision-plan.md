...
| --- | ---: | --- | --- |
| untested | 53 | The row was not reached by hosted smoke, the WSL full web suite, or targeted WSL probes yet. No product failure has been observed for these rows. | Write/run targeted WSL Playwright probes, then change each row to Pass, Pass w/ issues, Fail, or Removed. |
