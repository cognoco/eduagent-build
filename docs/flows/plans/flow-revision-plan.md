...
| LEARN-04 | Core learning loop | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| LEARN-05 | Coach bubble visual variants (light/dark) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| SUBJECT-03 | Create subject from chat (classifier miss) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-01 | Conversation-stage chips + feedback gating | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-02 | Greeting-aware subject classification | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| ID | Flow | Tested | Result | Bugs | Doc Updated | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| PRACTICE-01 | Practice hub menu | ⚠️ | Pass w/ issues | | | 2026-05-14 WSL full Playwright web: J-10 reached practice hub/actions, but the quiz launch path failed before round completion. |
...
| QUIZ-01 | Quiz activity picker (Capitals / Vocab / Guess Who) | ❌ | Fail | https://www.notion.so/3608bce91f7c81d0be00f2319683ea1e | | 2026-05-14 WSL full Playwright web: J-10 Practice → Quiz → launch failed before play/results; error context showed Retry/Go Back fallback. |
| QUIZ-02 | Round generation loading + 20s "still trying" hint | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-03 | Round play — multiple choice | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-04 | Round play — Guess Who clue reveal | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-05 | Mid-round quit with confirm | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-06 | Round complete error retry | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-07 | Results screen (celebration tier + soft-fail streak) | ❌ | Fail | https://www.notion.so/3608bce91f7c81d0be00f2319683ea1e | | 2026-05-14 WSL full Playwright web: J-10 failed before reaching quiz results. |
| QUIZ-08 | Quota / consent / forbidden typed errors | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| QUIZ-10 | Quiz round detail (per-question review) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-10 | Soft-fail side effects on completion | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-11 | Malformed-round guard (BUG-812 / F-015) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-12 | Wrong-answer dispute affordance (BUG-469 / BUG-927) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| QUIZ-13 | Answer-check failure inline warning (IMP-7 / BUG-799) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| DICT-07 | Photo review of handwritten dictation (vision LLM) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| DICT-08 | Sentence-level remediation | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| DICT-09 | Perfect-score celebration | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| HOMEWORK-03 | Manual fallback when OCR is weak | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| HOMEWORK-04 | Homework session multi-problem nav | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| HOMEWORK-05 | Gallery import | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| HOMEWORK-06 | Image pass-through to multimodal LLM | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| SUBJECT-04 | Create subject from homework branch | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| HOMEWORK-07 | Camera permission onboarding (two-state + Settings redirect) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| AUTH-11 | Session-expired forced sign-out | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| PARENT-08 | Subject raw-input audit | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| PARENT-09 | Guided label tooltip | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| PARENT-10 | Child-topic "Understanding" card + gated retention | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| CC-08 | Parent-facing metric vocabulary canon | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| BILLING-02 | Account/Profile -> Subscription: upgrade purchase + webhook polling | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| BILLING-09 | Top-up question credits | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| CC-06 | Top-up purchase confidence (two-stage polling) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| ID | Flow | Tested | Result | Bugs | Doc Updated | Notes |
| --- | --- | --- | --- | --- | --- | --- |
| CC-03 | Animation polish (icon, intent cards, celebrations) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| CC-11 | i18n / `t()` cross-cutting string layer | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-12 | FeedbackProvider + shake-to-feedback on gate screens | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-13 | Streaming error classification + stream-fallback guard | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-14 | Envelope-strip render guard at chat-bubble boundary (BUG-941) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-15 | RN Web stale-send block in ChatShell (BUG-886) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
| CC-16 | HMR-safe error type guards (BUG-947) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| CC-18 | Stable FlatList refs (PERF-10) | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| QA-06 | Focused-book generation regression | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| QA-09 | Consent email URL regression | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| QA-12 | Consent deny-confirmation regression | ⬜ |  | | | 2026-05-14: not covered by hosted Playwright web smoke run 25852959340 or the targeted WSL web probes run so far. This is an inventory coverage gap, not an observed product failure; needs a targeted WSL web probe or native/mobile pass. |
...
| 5  | Core Learning Sessions   | 12 | ❌ | 3 pass, 1 pass-w/issues, 3 fail, 5 untested. Targeted WSL web passed guided learning, first-session entry, read-only transcript, and voice-speed controls visibility; WSL full web failed Ask/freeform/session-summary path before completion, and the Library empty-state subject CTA routed home instead of create-subject. |
...
| 15 | Parent Dashboard         | 17 | ❌ | 5 pass, 2 pass-w/issues, 6 fail, 4 untested. Targeted WSL web passed multi-child dashboard, parent library, monthly reports, and accommodation rows; weekly report detail and retention-badge seed paths failed. |
...
| **Total** | | **184** | ⚠️ | 57✅ 31⚠️ pass-w/issues 22❌ 13 blocked 6 removed 55 untested. Hosted Playwright smoke passed 10/10; WSL full Playwright web ran 31 tests with 19 passed, 1 flaky setup, and 11 failed; targeted WSL web probes added settings/account/billing/learning/practice/dictation/retention/progress/subject-onboarding/parent-dashboard coverage without using the emulator. |
...
| --- | ---: | --- | --- |
| untested | 55 | The row was not reached by hosted smoke, the WSL full web suite, or targeted WSL probes yet. No product failure has been observed for these rows. | Write/run targeted WSL Playwright probes, then change each row to Pass, Pass w/ issues, Fail, or Removed. |
