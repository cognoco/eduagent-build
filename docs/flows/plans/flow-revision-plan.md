...
| PARENT-08 | Subject raw-input audit | ✅ | Pass | none | | 2026-05-14 targeted branch-local Playwright web rerun: `parent-with-children` opened child detail from Home, rendered `subject-card-Mathematics`, and showed `subject-raw-input-Mathematics` with `fractions homework`. |
