...
| QUIZ-05 | Mid-round quit with confirm | ❌ | Fail | https://www.notion.so/3608bce91f7c8147b974e7a9f276f80e | | 2026-05-14 targeted WSL Playwright web: quit modal appeared and Cancel kept the quiz playable, but confirming leave left quiz play visibly layered with Home/Practice content instead of cleanly showing the quiz index. 2026-05-14 fix branch: focused Jest verifies confirm quit now replaces to quiz index; no end-to-end rerun completed, so row remains Fail pending flow rerun. |
...
| QUIZ-08 | Quota / consent / forbidden typed errors | ❌ | Fail | https://www.notion.so/3608bce91f7c8107bae5eb4b90d1e7ee | | 2026-05-14 targeted WSL Playwright web: quota and consent launch errors rendered the error panel with Go Back and no Retry, but FORBIDDEN rendered "Couldn't create a round / Insufficient permissions" with Retry still visible. 2026-05-14 fix branch: focused Jest verifies ForbiddenError-shaped and CONSENT_REQUIRED launch failures suppress Retry; no end-to-end rerun completed, so row remains Fail pending flow rerun. |
...
| QUIZ-11 | Malformed-round guard (BUG-812 / F-015) | ❌ | Fail | https://www.notion.so/3608bce91f7c81afbfefec4fe77c058d | | 2026-05-14 targeted WSL Playwright web: malformed Capitals round rendered `quiz-play-malformed`, but pressing "Back to quiz home" left the user on the same malformed fallback instead of escaping. 2026-05-14 fix branch: focused Jest verifies malformed fallback Back to quiz home replaces directly to quiz index; no end-to-end rerun completed, so row remains Fail pending flow rerun. |
...
| 13 | Account Deletion         |  2 | ❌ | 1 pass-w/issues, 1 fail. WSL web probe rendered Delete account; scheduled deletion recovery still fails on main and is expected to be covered by PR 271 once merged. |
...
| 16 | Billing                  | 13 | ❌ | 6 pass, 6 pass-w/issues, 1 fail. WSL web probes covered current plan, trial/usage, family-pool visibility, restore/BYOK/top-up visibility, and found no Manage billing deep link on main; PR 271 is expected to cover BILLING-05 once merged. |
