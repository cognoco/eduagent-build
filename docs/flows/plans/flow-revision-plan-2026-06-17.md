...
| SUBJECT-06 | Broad subject → pick-book | ✅ | Pass | WI-858 | ✅ 2026-06-19 | Rerun passed through J-09 Chrome broad-subject branch to `/pick-book/[subjectId]`; pick-book unit coverage also passed. |
...
| SUBJECT-22 | Pick-book degraded/recovery states: missing-param guard; cycling loading + slow hint | ✅ | Pass | WI-858 | ✅ 2026-06-19 | Rerun evidence: pick-book unit coverage passed for missing-param, loading animation/slow-state, inline retry, and suggestion recovery states. |
...
| LEARN-50 | Challenge Round mobile surface | ✅ | Pass | WI-864 | ✅ 2026-06-19 | Rerun evidence: Challenge Round mobile, API, and shared schema suites passed, covering banner/offer/drill/note surfaces plus envelope/state-machine handling. |
