> **STATUS: DRAFT** - mentor audience flow revision plan. Created 2026-05-22. Last cleanup: 2026-05-29 (removed Done-bug citations from 14 rows; see `36c8bce91f7c810dac87c81009503508`).
...
| AUTH-10 | Sign out | Sign-out is available only from permitted surfaces. | 🚫 | Blocked | | ✅ 05-29 | Sign-out button hang was fixed (Done: `36b8bce91f7c8166b0abf009ef74face`). Row remains Blocked — a full live sign-out rerun with session teardown verification has not been completed yet. |
...
| ACCOUNT-03 | Add child profile from More or Profiles | Add-child from More/Profiles works as optional mentor setup. | 🚫 | Blocked | | ✅ 05-29 | Add-child subscription gate hang was fixed (Done: `36b8bce91f7c816a9cc8c86c2f45c059`). Row remains Blocked — a full live rerun through the create-child form has not been completed yet. |
| ACCOUNT-04 | Profile switching | Profile switching does not enter proxy for normal child review. | 🚫 | Blocked | | ✅ 05-29 | Child profile row navigation was fixed (Done: `36b8bce91f7c81c097f8cc060f836810`). Row remains Blocked — a full live rerun confirming child settings open has not been completed yet. |
| ACCOUNT-05 | Family-plan / max-profile gating | Family-plan/max-profile gates protect add-child setup. | 🚫 | Blocked | | ✅ 05-29 | Subscription-gate hang was fixed (Done: `36b8bce91f7c816a9cc8c86c2f45c059`). Row remains Blocked — a full live rerun verifying paywall/gate copy has not been completed yet. |
...
| ACCOUNT-24 | Post-approval landing | Post-approval landing restores child visibility. | 🚫 | Blocked | | ✅ 05-29 | Wrong-route consent harness bug was fixed (Done: `36c8bce91f7c81b2ad33e27aab4f539a`). Row remains Blocked — a full live post-approval email-link rerun has not been completed yet. |
...
| ACCOUNT-28 | App language picker | App language picker works from permitted account surface. | 🚫 | Blocked | | ✅ 05-29 | Animated-splash intercept bug was fixed (Done: `36b8bce91f7c81aca1add2d79913bf9d`). Row remains Blocked — a live tap-through to the language picker has not been confirmed yet. |
...
| HOME-02 | Parent gateway home | Family/Children home summarizes children and routes to mentor surfaces. | ⚠️ | Pass w/ issues | https://www.notion.so/36b8bce91f7c81f7a161f229f3ab7649 | ✅ 05-29 | Parent journey setup mismatch was fixed (Done: `36c8bce91f7c8196a766c9bc9ce12aad`). Child subject drill-down (`36b8bce91f7c81f7a161f229f3ab7649`) remains the open blocker for full child-curriculum judgment from this home. |
| HOME-03 | Parent tabs and parent-mode navigation | Mentor tab target is home/recaps/progress/more when implemented. | ✅ | Pass | | ✅ 05-29 | Parent journey setup mismatch was fixed (Done: `36c8bce91f7c8196a766c9bc9ce12aad`). Historical hidden/undefined route exposure is also Done. No remaining active bug for this row. |
...
| HOME-07 | Add-first-child gate (family/pro plans) | Family setup offers add/link child plus continue-studying path. | 🚫 | Blocked | | ✅ 05-29 | Original Fail bug was fixed (Done: `36b8bce91f7c8112a606dc04e8a64864`). Row moves from Fail to Blocked — a fresh live rerun with a reliable adult-without-children seed has not been completed to confirm the fix holds end-to-end. |
...
| SUBJECT-02 | Create subject from library empty state | Create child subject from child curriculum empty state, not adult Library. | 🚫 | Blocked | https://www.notion.so/36b8bce91f7c81f7a161f229f3ab7649 | ✅ 05-29 | Student-activity-routes bug was deleted (fixed). Child curriculum drill-down (`36b8bce91f7c81f7a161f229f3ab7649`) remains the active blocker. |
| SUBJECT-03 | Create subject from chat classifier | Chat classifier fallback is not a normal Mentor route. | 🚫 | Blocked | | ✅ 05-29 | Student-activity-routes bug was deleted (fixed). Row remains Blocked — student chat-classifier entry from mentor context was not exercised. |
| SUBJECT-04 | Create subject from homework | Homework subject creation is not a normal Mentor route. | 🚫 | Blocked | | ✅ 05-29 | Student-activity-routes bug was deleted (fixed). Row remains Blocked — student homework subject-creation was not exercised from mentor context. |
...
| ID | Flow | Access expectation | Tested | Result | Bugs | Doc Updated | Notes |
| --- | --- | --- | --- | --- | --- | --- | --- |
| PARENT-01 | Parent dashboard | Family home/dashboard works for linked children. | ✅ | Pass | | ✅ 05-29 | Parent journey setup mismatch was fixed (Done: `36c8bce91f7c8196a766c9bc9ce12aad`). Family home/dashboard works as described with linked children. |
| PARENT-02 | Multi-child dashboard | Multi-child dashboard works. | ✅ | Pass | | ✅ 05-29 | Parent journey setup mismatch was fixed (Done: `36c8bce91f7c8196a766c9bc9ce12aad`). Multi-child dashboard renders correctly with M-C seed. |
| PARENT-03 | Child detail drill-down | Child detail is parent-native and scoped. | ⚠️ | Pass w/ issues | https://www.notion.so/36b8bce91f7c81f7a161f229f3ab7649 | ✅ 05-29 | Child detail click path renders scoped Emma content. Child subject drill-down (`36b8bce91f7c81f7a161f229f3ab7649`) remains the only active downstream blocker. |
...
| PARENT-07 | Parent library view | Child curriculum replaces top-level adult Library in Mentor mode. | 🚫 | Blocked | https://www.notion.so/36b8bce91f7c81f7a161f229f3ab7649 | ✅ 05-29 | Historical Family-shell Library/undefined-route bug is Done. Full judgment still blocked by the open child subject route wedge (`36b8bce91f7c81f7a161f229f3ab7649`). No remaining own-bug, so reclassified from Pass w/ issues to Blocked. |
...
| LEARN-10 | Book detail and start learning | Book detail starts learning only in correct student context. | 🚫 | Blocked | | ✅ 05-29 | Adult Library is reachable inside the Family shell, but book-detail/start-learning was not launched because the route exposure is already off-scope for Mentor mode. |
...
| QUIZ-02 | Round generation loading screen | Quiz launch is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Direct `/quiz` is incorrectly reachable in Family shell; round generation was not launched because the top-level route exposure is already filed as off-scope. |
| QUIZ-03 | Round play — multiple choice | Quiz play is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Quiz play is downstream of the off-scope `/quiz` route exposure in Family shell. |
| QUIZ-04 | Round play — Guess Who clue reveal | Guess Who play is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Guess Who play is downstream of the off-scope `/quiz` route exposure in Family shell. |
| QUIZ-05 | Mid-round quit | Quiz quit path is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Mid-round quit requires launching a student quiz from the off-scope Family-shell route. |
| QUIZ-06 | Round complete error retry | Quiz retry/exit path is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Quiz retry/exit requires launching student quiz play from the off-scope Family-shell route. |
| QUIZ-07 | Results screen | Quiz results are not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Quiz results require completing student quiz play from the off-scope Family-shell route. |
| QUIZ-08 | Quiz quota / consent / forbidden errors | Quiz errors are not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Quiz quota/consent error states require specific quota/consent seeds and launching the off-scope quiz route. |
...
| DICT-02 | OCR text preview + edit | Dictation OCR preview is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Dictation entry is off-scope but reachable in Family shell; OCR preview/edit was not launched from that student route. |
...
| DICT-04 | Playback screen | Dictation playback is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Playback is downstream of the off-scope Dictation route exposed in Family shell. |
| DICT-05 | Mid-dictation exit confirm | Dictation exit confirm is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Exit confirmation requires launching a student dictation flow from the off-scope Family-shell route. |
| DICT-06 | Completion screen | Dictation completion is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Completion requires running a student dictation flow from the off-scope Family-shell route. |
| DICT-07 | Photo review of handwritten dictation | Dictation photo review is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Photo review/camera behavior is downstream of the off-scope route and partly native-only. |
| DICT-08 | Sentence-level remediation | Dictation remediation is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Remediation requires completing a student dictation flow from the off-scope Family-shell route. |
| DICT-09 | Perfect-score celebration | Dictation perfect-score celebration is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Perfect-score state requires completing a student dictation flow from the off-scope Family-shell route. |
| DICT-10 | Recording dictation result | Dictation result recording is not directly surfaced from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Result recording requires running the off-scope dictation student flow. |
...
| HOMEWORK-04 | Homework tutoring session | Homework tutoring is not direct child impersonation from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Homework tutoring is downstream of the off-scope `/homework` route exposed in Family shell. |
| HOMEWORK-05 | Gallery import | Homework gallery import is not direct child impersonation from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Gallery import is downstream of the off-scope homework route and partly native/file-picker dependent. |
| HOMEWORK-06 | Image pass-through to vision LLM | Homework vision pass-through is not direct child impersonation from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Vision pass-through requires launching the off-scope homework flow and providing an image. |
| HOMEWORK-07 | Camera permission onboarding | Homework permission flow is not direct child impersonation from Mentor mode. | 🚫 | Blocked | | ✅ 05-29 | Camera permission onboarding is downstream of the off-scope homework route and requires browser/native permission state. |
...
| RECAP-TARGET-02 | Recap detail back-fallback to `/(app)/recaps` | Recap detail is parent-native and backs to `/(app)/recaps`. | ⚠️ | Code verified, E2E re-run pending | https://www.notion.so/36b8bce91f7c81d19223ee40435187ed | ✅ 05-29 | BUG-772 investigation (05-29): row press handler (`recaps/index.tsx`) does a synchronous same-stack `router.push({ pathname: '/(app)/recaps/[recapId]', params })`; `recaps/_layout.tsx` exports `unstable_settings.initialRouteName='index'`; detail backs via `goBackOrReplace(router, FAMILY_RECAPS_HREF)`. No hang vector in code. Added `recaps/index.test.tsx` asserting the press navigates with the exact target (red-green). The 45s hang attributed to web-preview/Metro lazy-bundle stall, not a code defect. Re-run Playwright parent flow against a fresh build to fully clear. |
...
| BRIDGE-02 | "Add to my learning" writes as adult | "Add to my learning" writes as adult, not as child. | 🚫 | Blocked | | ✅ 05-29 | Add-to-my-learning click hang was fixed (Done: `36b8bce91f7c81d8a1f3dc69d960481d`). Row remains Blocked — a live rerun confirming write scope (adult, not child) has not been completed yet. |
| BRIDGE-03 | Adult quota / paywall before Study bridge | Adult quota/paywall appears before Study bridge if needed. | 🚫 | Blocked | | ✅ 05-29 | Add-to-my-learning click hang was fixed (Done: `36b8bce91f7c81d8a1f3dc69d960481d`). Row remains Blocked — a live rerun exercising the quota/paywall branch has not been completed yet. |
| BRIDGE-04 | Back-nav after bridge avoids stale child/proxy | Back navigation after bridge does not return to stale child/proxy route. | 🚫 | Blocked | | ✅ 05-29 | Add-to-my-learning click hang was fixed (Done: `36b8bce91f7c81d8a1f3dc69d960481d`). Row remains Blocked — a live rerun exercising bridge destination and back-nav has not been completed yet. |
...
| 2 | Mentor Home, Navigation, Setup, And Child Curriculum | 20 | ⚠️ | 5 pass, 1 pass w/ issues, 0 fail, 14 blocked; HOME-07 moved to Blocked (bug Done); child subject route remains active blocker. |
| 3 | Child Review, Recaps, Reports, And Mentor Progress | 21 | ⚠️ | 9 pass, 3 pass w/ issues, 9 blocked; PARENT-01/02 cleared (bug Done); PARENT-07 moved to Blocked; open issues are child subject wedge and recap detail. |
...
| **Total** | | **167** | ⚠️ | 73 pass, 6 pass w/ issues, 0 fail, 88 blocked. No audit rows remain unstarted. Updated 2026-05-29: cleared Done-bug citations from 14 rows. |
...
Current blocker groups after this rerun (updated 2026-05-29):

- **Family entry / parent shell assumptions:** ~~J03-J07, J16-J18, and J21 failures show the user lands on adult `My Learning` with a visible `Children` switch~~ — **resolved** (bug `36c8bce91f7c8196a766c9bc9ce12aad` Done). HOME-02/HOME-03 and PARENT-01/02/03 rows updated.
- **Consent approval route:** ~~`mentor-audit-post-approval-redirect` opens unmatched mobile `/consent/approve`~~ — **resolved** (bug `36c8bce91f7c81b2ad33e27aab4f539a` Done). ACCOUNT-24 updated.
- **Auth session invalidation:** ~~`mentor-audit-session-expired`/`session-revoked` storage mutation does not surface sign-in banners~~ — **resolved** (bug `36c8bce91f7c811a9243fdb4ab44a94b` Done).
- **MFA:** ~~`mentor-audit-mfa-totp` fails with Clerk `405`~~ — **resolved** (bug `36c8bce91f7c819f96a1fdae498abaca` Done).
...
| Parent journey harness mismatch | **Done (2026-05-29).** Bug `36c8bce91f7c8196a766c9bc9ce12aad` is Done. | J03 rerun on 2026-05-26 failed both parent gateway tests. Fix verified. | HOME-02/HOME-03 and PARENT-01/02/03 rows updated; HOME-03/PARENT-01/02 moved to Pass. |
| Wrong harness / wrong surface | **Done (2026-05-29).** Bug `36c8bce91f7c81b2ad33e27aab4f539a` is Done. | `mentor-audit-post-approval-redirect` unmatched route fixed. | ACCOUNT-24 row updated; row moved to Blocked pending live rerun. |
| Auth fixture gap | **Done (2026-05-29).** Bug `36c8bce91f7c811a9243fdb4ab44a94b` is Done. | `mentor-audit-session-expired`/`session-revoked` fixture gaps fixed. | No active row change required — rows were already Blocked. |
| Environment/provider/native limits | **Done (2026-05-29).** MFA bug `36c8bce91f7c819f96a1fdae498abaca` is Done. Other provider/native branches remain not testable in Chrome without dedicated fixtures. | MFA TOTP seed issue resolved; email/OAuth/camera/store branches remain provider/native-bound. | No active row change required — rows were already Blocked. |
...
| --- | --- | --- |
| Current open product blockers | `PARENT-07` child-subject branch, `RECAP-TARGET-01`, `CC-18` | Keep active with live-repro bugs: child subject wedge is open Notion `36b8bce91f7c81f7a161f229f3ab7649`; recap detail hang is open Notion `36b8bce91f7c81d19223ee40435187ed`. |
| Rows moved from Fail/Pass-with-issues after Done-bug cleanup (2026-05-29) | `HOME-07` (Fail→Blocked), `HOME-03` (Pass w/ issues→Pass), `PARENT-01` (Pass w/ issues→Pass), `PARENT-02` (Pass w/ issues→Pass), `PARENT-07` (Pass w/ issues→Blocked), plus Done-link removals on ACCOUNT-03/04/05/24/28, AUTH-10, BRIDGE-02/03/04 | Bugs `36b8bce91f7c8112a606dc04e8a64864` (HOME-07), `36c8bce91f7c8196a766c9bc9ce12aad` (parent journey), `36c8bce91f7c81b2ad33e27aab4f539a` (consent route), `36c8bce91f7c811a9243fdb4ab44a94b` (session expired), `36c8bce91f7c819f96a1fdae498abaca` (MFA), `36b8bce91f7c816a9cc8c86c2f45c059` (add-child gate), `36b8bce91f7c81c097f8cc060f836810` (profile row), `36b8bce91f7c8166b0abf009ef74face` (sign-out hang), `36b8bce91f7c81d8a1f3dc69d960481d` (bridge hang), `36b8bce91f7c81aca1add2d79913bf9d` (splash blocker) are all Done. Stale citations removed. |
| New current harness/contract bugs filed on 2026-05-26 — now all Done | `HOME-02`, and parent-journey dependent rows; inclusive mentor audit excluded entries | Bugs `36c8bce91f7c8196a766c9bc9ce12aad`, `36c8bce91f7c81b2ad33e27aab4f539a`, `36c8bce91f7c811a9243fdb4ab44a94b`, `36c8bce91f7c819f96a1fdae498abaca` are all Done. Rows retain Pass w/ issues only where a separate open blocker exists. |
...
| Former pass-with-issues rows with no bug link | `AUTH-14`, `ACCOUNT-24`, `SUBJECT-16`, `SUBJECT-17`, `BILLING-03`, `BILLING-09` | Refreshed. `SUBJECT-16`, `SUBJECT-17`, `BILLING-03`, and `BILLING-09` now pass for their Chrome-visible surfaces. `AUTH-14` is blocked on an injected stuck-state fixture. `ACCOUNT-24` is blocked — consent approval route harness bug was Done; full live rerun not yet completed. |
...
Row IDs that remain `Fail` or `Pass w/ issues` after 2026-05-29 cleanup:

- `Fail`: none.
- `Pass w/ issues`: `HOME-02` (open child-subject blocker `36b8bce91f7c81f7a161f229f3ab7649`), `PARENT-03` (same open blocker), `PARENT-11` (recap detail hang `36b8bce91f7c81d19223ee40435187ed`), `LEARN-18` (child subject blocker), `RECAP-TARGET-01` (recap detail hang), `CC-18` (recap detail hang).
