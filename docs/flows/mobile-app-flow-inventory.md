...
| CC-03 | Animation polish (icon transitions, intent card press, celebrations) | `BrandCelebration`, `IntentCard` (now uses left accent border + icon), session message animations. See `2026-04-16-animation-improvements-design.md`. |
