...
## Local redacted receipt manifest

The detailed receipts remain local-only under `.workitem-artifacts/WI-2939/`; their
hashes make the evidence immutable without tracking the large raw log.
...
The preserved local archive is
