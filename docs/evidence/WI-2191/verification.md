...
- Focused production Chromium regression: 3/3 tests passed in 86 seconds.
  Output: `docs/evidence/WI-2191/green-web-focused.json`.
- Full relevant Playwright selection: 10/10 tests passed in 3.6 minutes,
