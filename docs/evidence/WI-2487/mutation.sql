...
BEGIN
  IF actual_project IS DISTINCT FROM expected_project
     OR actual_branch IS DISTINCT FROM expected_branch THEN
    RAISE EXCEPTION
      'WI-2487 target mismatch: expected project % branch %, found project % branch %',
      expected_project,
      expected_branch,
      actual_project,
      actual_branch;
