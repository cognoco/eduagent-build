...
- **Promotion of this ADR requires the identity canon's vocabulary correction to land in the same change-set.** The term "graduation" names more than one transition across the identity canon; the correction reserves it for the consent-capability crossing, names the login transition *account detachment*, and records both the entitlement floor and the resulting split of the affected canon requirement. Those canon edits are enumerated in the S2-06A disposition ledger. This ADR may not be promoted while the canon it renames still says otherwise — the §II.2 lockstep is satisfied at promotion, not deferred past it.
