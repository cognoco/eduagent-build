...
> **STATUS UPDATE (2026-07-14): GOVERNING V2 DIRECTION; S0–S5 SUBSTANTIALLY LIVE.** Mentor/Subjects/Journal, scope/support cold start, visibility, shared records, and link ceremony are implemented. Development and preview enable V2; production keeps V2 off. S6 production cutover and irreversible V0/V1 deletion remain explicitly deferred and require the product retirement ruling.
...
These drawings are the historical review entry point for "which screen does what, when is it triggered, why does it exist, and who can access it." The archived screen matrix lives in [`06-screen-function-access-map.md`](../_archive/plans/2026-07-14-superseded/v2-dossier/06-screen-function-access-map.md); the archived trigger map lives in [`07-trigger-flow-logic-map.md`](../_archive/plans/2026-07-14-superseded/v2-dossier/07-trigger-flow-logic-map.md).
