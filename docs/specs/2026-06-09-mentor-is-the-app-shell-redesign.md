...
These drawings are the review entry point for "which screen does what, when is it triggered, why does it exist, and who can access it." The archived code-backed screen matrix lives in [`06-screen-function-access-map.md`](../_archive/plans/2026-07-14-superseded/v2-dossier/06-screen-function-access-map.md); the archived trigger-level logic map lives in [`07-trigger-flow-logic-map.md`](../_archive/plans/2026-07-14-superseded/v2-dossier/07-trigger-flow-logic-map.md).
