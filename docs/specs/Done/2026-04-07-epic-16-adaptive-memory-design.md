...
**Amendments integrated:** 2026-04-09 — Amendment 2 (Epic 15 mastery cross-reference → FR247.4.1) and Amendment 3 (memory layer deduplication → FR245.8) from `docs/plans/2026-04-08-epic-16-amendments.md` formalized as spec requirements.
