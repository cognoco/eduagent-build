...
- Unavailable or malformed judging commits no transition before the cap. On the third learner response, an unresolved evaluation — and only an unresolved evaluation — deterministically terminalizes as `not_yet/insufficient`.
