...
|---|---|---|---|
| **L1 — Canon** | The *what*: contracts, invariants, target models, product truth | `docs/canon/` (target; loose root docs drain here in Phase J/Stream 2) | *(this index, § Canon)* |
...
➡ **[`_wip/identity-foundation/CANONICAL-SET.md`](../_wip/identity-foundation/CANONICAL-SET.md)** — the locked set (17 members), each with its role.

The members, at a glance (full roles + status in the canonical-set doc):

- **Domain docs (L1):** [`identity-ontology.md`](../_wip/identity-foundation/identity-ontology.md) · [`domain-model.md`](../_wip/identity-foundation/domain-model.md) · [`data-model.md`](../_wip/identity-foundation/data-model.md) · [`identity-foundation-prd.md`](../_wip/identity-foundation/identity-foundation-prd.md)
- **Decisions (L2):** [`MMT-ADR-0000`](adr/MMT-ADR-0000-documentation-layer-model-and-decisions-layer.md) (+ 2 amendments) · `MMT-ADR-0007`–`0010` (domain) · `MMT-ADR-0011`/`0012` (data) · `MMT-ADR-0013`–`0016` (policy-engine spine) — all under [`docs/adr/`](adr/)
