...
[`docs/adr/README.md`](adr/README.md). Current ADRs: `MMT-ADR-0000`–`0019`, `MMT-ADR-0021`, `MMT-ADR-0022`, the reconstructed `0023`–`0052` series (Proposed unless marked; `0052` — consent authority from age + residence jurisdiction — is Accepted), and `0054` (mobile release policy — runtimeVersion, flag tuples, channel ownership; Accepted)
