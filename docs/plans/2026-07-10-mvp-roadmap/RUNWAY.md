...
- **Dogfood prod build (WI-1503) → closed beta (WI-1506, families screened for 13+ teens; WI-1655 device-evidence batch runs with it) → store go-live → public launch.**
  - ⚠ **Screening criterion has an open hole (WI-2535, 2026-07-30) — flagged, not rewritten.** "Screened for 13+ teens" assumes a 13+ teen can transact the family model unaided. Because consent authority resolves from age × residence jurisdiction and WI-1753 remains 17+-only until WI-2533 lands, a recruited family whose teens are all **13–16** may be unable to exercise the family model. Narrowing the criterion (to 17+, or to jurisdictions where 13+ self-consents) is a **product call and is not taken here** → operator/PM ruling needed.
