...
- [x] R5: Produce a fresh red → candidate-green → exact production-revert-red → hash-verified restore-green record for the 13-suite, 589-case focused set in `.workitem-artifacts/WI-2543-r2/red-green-revert.md`.
