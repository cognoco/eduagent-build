...
> **STATUS (2026-06-27):** IMPLEMENTED. `mentor.tsx` + all 9 mentor components, local-first `bar-intent-match`, feed cache, deep-link expander, V2 post-auth handoff, and the `V2_TABS` (mentor/subjects/journal) navigation-contract branch all landed behind `MODE_NAV_V2_ENABLED`. No remaining scope.
