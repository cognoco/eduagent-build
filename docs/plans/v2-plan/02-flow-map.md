...
| S2 -> S3 evidence gate | Flow-level evidence for S1/S2 entry success: feed card open, bar intent match, hub reach, topic/session start, homework start, cold-start conversion **plus parent/supporter comprehension**: a linked parent can answer "what did my kid work on this week?" from the app alone in under one minute. Current parent surfaces remain covered until S4/S5 heirs replace them |
