...
**Related docs:** [`2026-07-23-13-plus-eea-launch-country-ruling.md`](2026-07-23-13-plus-eea-launch-country-ruling.md), [`2026-07-06-eu-ai-act-technical-file-qms-skeleton.md`](2026-07-06-eu-ai-act-technical-file-qms-skeleton.md), [`../architecture.md`](../architecture.md)

> **Classification authority.** This file is a product gate, not a classification.
> The current EU AI Act classification and territorial analysis — Annex III scope,
> the Article 6(3) no-significant-risk exception, EEA-incorporation status, and the
> third-country-provider/authorised-representative question — is open with counsel
> and the DPO. The authoritative statement of that open item is
> [`2026-07-23-13-plus-eea-launch-country-ruling.md`](2026-07-23-13-plus-eea-launch-country-ruling.md)
> and the classification review request under [`DPO exchanges/`](DPO%20exchanges/).
> Nothing here decides classification.
...
This is a hard product/legal gate. It applies even if the underlying tutoring functionality already exists in the consumer app. The canonical statement of the prohibition lives in [`../architecture.md`](../architecture.md) Consumer Family Compliance Boundary; this file is its operational packet.
...
|---|---|
| Reclassification memo | Counsel/DPO decision on whether the exact intended purpose is high-risk under EU AI Act Annex III point 3, whether the Article 6(3) exception applies, and which provider/deployer obligations follow. Closes the open item recorded in the launch-country ruling. |
...
| Surface | Gate |
|---|---|
| Architecture | [`../architecture.md`](../architecture.md) Consumer Family Compliance Boundary. |
| Compliance | This file, with classification held open by [`2026-07-23-13-plus-eea-launch-country-ruling.md`](2026-07-23-13-plus-eea-launch-country-ruling.md). |
| Store submission | [`../screenshots_and_store_info/app-privacy-data-safety-worksheet.md`](../screenshots_and_store_info/app-privacy-data-safety-worksheet.md) submission blocker and copy notes. |
