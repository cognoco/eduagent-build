...
|---|------|-------|--------|-------|
| P1 | Create `dpo@zwizzly.com`, confidential direct forward to Stephan, test; do NOT publish or register yet | Zuzana (domain admin) | **unblocked 2026-07-30** | Stephan ruled forwarding-only, with controls: min named admins, change logging, no distribution group, delivery-failure monitoring, external test with him. Our side adds metadata-only delivery log (timestamp/sender/subject/status — no content; notified in 2026-07-30 reply, proceed unless he objects) + delivery alert w/ 3-working-day relay-chase rule. NO BCC/journal rule (would copy content). Critical path for appointment effective date |
...
| P3 | Review + sign External DPO Services Agreement + Formal Designation | Zuzana (chair, sole signatory needed) | **unblocked 2026-07-30** | Stephan supplied replacement scope wording (accepted verbatim — see reply §5): Art 38/39 tasks cover ALL GDPR processing regardless of data-subject location; non-EEA substantive advice out unless separately agreed; he may escalate overlapping non-EEA issues; EU AI Act work outside statutory DPO function (separate advice — commercial basis queried, reply Q3). Sign both docs with his wording; effective date = dpo@ activation; then notify Datatilsynet |
