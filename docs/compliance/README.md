...
**Master checklist:** [`minors-compliance-requirements.md`](minors-compliance-requirements.md) — LIST A (live) / LIST B (dormant at 13+).
**Historical verified data map:** [`2026-06-07-data-retention-and-erasure-audit.md`](../_archive/audit/2026-07-14-stale-audit-cleanup/2026-06-07-data-retention-and-erasure-audit.md).
...
| A5 | Privacy policy | Done (rewritten 2026-06-08) | [`privacy-policy.html`](privacy-policy.html) — pre-publish TODO open (DPO name, address, Art 27 rep) |
...
- The **DPIA** and **ROPA** are written against the ratified identity model ([`docs/canon/identity/data-model.md`](../canon/identity/data-model.md)), citing it as the design source. Re-confirm against the built schema before final DPIA sign-off.
