...
was found between the table and the memo.
...
> (`30.07.Answer.docx`) is the last DPO document held in full. What does exist is two independent
> attestations, both authored by the operator rather than by an agent:
>
