...
| **Jørn Kjetil Jørgensen** — Founder, ZWIZZLY AS *(confirmed by the operator 2026-08-07)* | Holds technical and engineering oversight: ratifies architecture decision records (e.g. MMT-ADR-0052/0055, accepted 2026-08-05), implements operational infrastructure (e.g. the DPO contact mailbox, WI-2916), and directs and reviews agent-executed engineering work. | L3, L6, and L7 at implementation depth (per §3); L1–L2 at awareness depth, since engineering choices (a new model, a new integration) can themselves be reassessment triggers. |
...
| v0.2.1 | 2026-08-07 | Second founder's full legal name recorded (Jørn Kjetil Jørgensen; operator-supplied 2026-08-07), replacing the "to be added at signature time" placeholder in §2. | agent-drafted for management review |
