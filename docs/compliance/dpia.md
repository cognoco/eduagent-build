...
> **⚠️ Entity reconciliation required (C3, 2026-07-04 closure check):** the published privacy policy names the controller as **"Cognoco s.r.o."** (`docs/compliance/privacy-policy.html:21,66`) while this DPIA says "established in Norway". Counsel must reconcile the controlling legal entity — which also determines the lead supervisory authority — across DPIA, ROPA, and privacy policy before publish.
...
**Companion documents:** [`ropa.md`](ropa.md) (data register), [`art9-special-category-decision.md`](art9-special-category-decision.md), [`breach-response-plan.md`](breach-response-plan.md), [`minors-compliance-requirements.md`](minors-compliance-requirements.md) (LIST A).
**Schema source of truth:** the **built, live schema** (`packages/database/src/schema/identity.ts`), designed per [`docs/canon/identity/data-model.md`](../canon/identity/data-model.md). Legacy data-flow evidence: [`2026-06-07-data-retention-and-erasure-audit.md`](../_archive/audit/2026-07-14-stale-audit-cleanup/2026-06-07-data-retention-and-erasure-audit.md). Built-state verification: [`2026-07-04-launch-compliance-closure-check-early-pass.md`](2026-07-04-launch-compliance-closure-check-early-pass.md).
