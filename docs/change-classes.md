...
| **integration-typecheck** | `tests/integration/**`, checker inputs, CI | `typecheck:integration` | `test:integration` | Roots come directly from `tests/integration/jest.config.cjs` |
