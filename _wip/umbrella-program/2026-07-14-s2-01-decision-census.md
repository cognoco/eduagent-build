...
| 55 | MentoMate does not solicit or intend to use GDPR Article 9 data; incidental disclosure/inference remains foreseeable and subject to DPO/privacy advice and minimisation controls | `docs/compliance/art9-special-category-position.md` (current proposed position); superseded categorical decision retained in `docs/compliance/history/2026-06-08-art9-no-processing-decision-superseded.md` | single-canon | **SHOULD** | PASS — trigger 3 (privacy/compliance NFR) + trigger 1 (constrains all future prompt/classifier work) | Yes — categorical 2026-06-08 position superseded 2026-07-24 |
