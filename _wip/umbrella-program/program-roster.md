...
| PRG-11 | architecture | 24 (+3 merged: F-169/170/171) | **partly in-radius** (god-modules/pkg-boundaries; some lands W1) | gate **FIRED 06-11** (G3 "W1 landed") — **moot scan RUNNING 2026-06-11** (read-only agent → `supporting-artefacts/prg-11-moot-scan.md`) |
...
| 8 | **PRG-11** architecture | IF "W1 landed" ✅ + moot-by-refactor scan (**running 2026-06-11**, vs the full landed file-touch set W0–W2 + early W3/W4) |
