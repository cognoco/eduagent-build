...
> **LD2 — RULED: Option 1** — §3 spine adopted + the legal-dependency register (`2026-07-15-legal-dependency-plan.md`) with Cosmo Blocked-by edges as live state; clocks start the same week. WI-1111 remains counsel-routed through OPQ-22. **WI-1559 update:** the 2026-07-11 operator ruling resolved the controller as ZWIZZLY AS, org.nr 811696072, Fiskekroken 3B, 0139 Oslo, Norway, with Norwegian Datatilsynet as lead authority; active-document reconciliation is complete. OPQ reconciliation ruled Option 1: all wholly-operator legal items got OPQ rows (OPQ-102..115); standing rule — wholly-operator items get OPQ rows at capture.
