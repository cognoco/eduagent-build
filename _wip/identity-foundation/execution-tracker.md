...
| WI-692 | CUT-B2 | consent + family cutover — write machine, coexistence break tests, deletion/export twins | P1 | WI-691 ✓ | **in-progress** — `wi692-executor` dispatched 2026-06-13 (691 closed); phase-0 STOP. Consent WRITE machine (reuses CUT-B1 read module) + guardianship reads + deletion/export D2/D3 compliance legs + GDPR/COPPA coexistence break tests. ∥ B3 |
| WI-693 | CUT-B3 | billing + webhooks cutover — subscription core, webhook twins, quota/trial chain | P1 | WI-691 ✓ | **in-progress** — `wi693-executor` dispatched 2026-06-13 (691 closed); phase-0 STOP. Billing core + both webhook handler twins (BUG-116/CR-M11 race break-tests re-run red-green) + §1.4 store-correlation columns. ∥ B2 |
