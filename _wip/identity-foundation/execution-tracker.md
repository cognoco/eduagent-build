...
| WI-576 | WP-W2-consent-deletion | consent authority + account-isolated deletion + fail-closed age-gate (F-093, F-029-semantic; regression-ACs F-118/122/130/145) | WP | P1 | WI-572, WI-574 | **merged** — PR #888 merge-gated + merged 2026-06-11 after one fix round (GC6 conversion; merge 400f2644); children WI-602/603 pre-swept at merge time per the standing step; executor firing `complete` |
