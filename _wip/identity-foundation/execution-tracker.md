...
| WI-580 | IT-W3-pii-llm-provider | child name out of LLM-provider prompts (F-076) | Item | P3 | WI-571, WI-574 | **merged** — PR #900 merged 2026-06-11 (582201b0; 3 rounds: base + boundary-year-conservative gate + schemas promotion). Solo Item, no children; executor firing `complete`. Eval-hook gate-gap = WI-619 (hit 3×) |
