...
| 5 | WI-625 WP-L12-pluralization | review — PR #1011 **MERGED** `ddf462f3e` (3 rounds; in-PR forward guard caught 3 audit-missed sites; pl 71/71 families); children WI-657/658 swept; `complete` firing |
...
| 8 | WI-628 WP-L12-decorative-lowvision | **review** — PR #1014 `e2fb5779c` (2 commits; text-floor guard shipped; decorative-hiding guard documented-infeasible per Amendment 16; RNTL v13 includeHiddenElements pattern applied to 8 affected test files) |
